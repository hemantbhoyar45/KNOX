...
import { n as Hls, t as CapLevelController } from "./hls-BSdqqcMp.js";
...
var be$2 = G$3(Q$2());
var Je$1 = G$3(Q$2());
var yt$2 = G$3(Q$2()), P$3 = { now: function() {
...
var ee$3 = function() {
	...
	var s = P$3.now(), u = s == null ? void 0 : s.toString(16).substring(3);
...
var Vt$2 = function() {
	...
	function r(e) {
		...
		e.on("playbackheartbeatend", n), e.on("seeking", n), e.on("rebufferstart", n), e.on("adplaying", function() {
			...
			t._playbackTimeTrackerLastPlayheadPosition = -1, t._lastTime = P$3.now(), t._isAdPlaying = !1, t._callbackUpdatePlaybackTime = null;
		});
	}
	return N$1(r, [
		{
			...
			value: function() {
				this._callbackUpdatePlaybackTime === null && (this._callbackUpdatePlaybackTime = this._updatePlaybackTime.bind(this), this._playbackTimeTrackerLastPlayheadPosition = this.pm.data.player_playhead_time, this._lastTime = P$3.now(), this.pm.on("playbackheartbeat", this._callbackUpdatePlaybackTime));
			}
		},
		{
		...
		},
		{
			...
			value: function() {
				var t = this.pm.data.player_playhead_time || 0, i = P$3.now(), a = i - this._lastTime, n = -1;
...
var Jt$2 = function() {
	...
	function r(e) {
		...
		S$3(this, r), l$3(this, "_lastCheckedTime", void 0), l$3(this, "_lastPlayheadTime", void 0), l$3(this, "_lastPlayheadTimeUpdatedTime", void 0), l$3(this, "_rebuffering", void 0), l$3(this, "pm", void 0), this.pm = e, !(e.disableRebufferTracking || e.disablePlayheadRebufferTracking) && (this._lastCheckedTime = null, this._lastPlayheadTime = null, this._lastPlayheadTimeUpdatedTime = null, e.on("playbackheartbeat", this._checkIfRebuffering.bind(this)), e.on("playbackheartbeatend", this._cleanupRebufferTracker.bind(this)), e.on("seeking", function() {
			t._cleanupRebufferTracker(null, { viewer_time: P$3.now() });
		}));
	}
	return N$1(r, [
		{
	...
	function r(e) {
		...
		S$3(this, r), l$3(this, "pm", void 0), this.pm = e, e.on("viewinit", function() {
			...
			if (!i.view_program_changed) {
				var n = function(o, s) {
					var u = s.viewer_time;
					o.type === "playing" && typeof e.data.view_time_to_first_frame == "undefined" ? t.calculateTimeToFirstFrame(u || P$3.now(), a) : o.type === "adplaying" && (typeof e.data.view_time_to_first_frame == "undefined" || t._inPrerollPosition()) && t.calculateTimeToFirstFrame(u || P$3.now(), a);
				};
...
var xa$1 = 2e3, Kt$2 = function r(e) {
	...
	var i = -1, a = function() {
		var n = P$3.now(), o = (e.data.viewer_time || n) - (i || n);
...
var $t$2 = function r(e) {
	...
	var i = function() {
		t.lastWallClockTime = P$3.now(), e.on("before*", a);
	}, a = function(n) {
		var o = P$3.now(), s = t.lastWallClockTime;
...
$$2.prototype._sendBeaconQueue = function() {
	...
	var t = this._createPayload(e), i = P$3.now();
	Cr(this._beaconUrl, t, !1, function(a, n) {
		n ? (r._eventQueue = e.concat(r._eventQueue), r._failureCount += 1, q$1.info("Error sending beacon: " + n)) : r._failureCount = 0, r._roundTripTime = P$3.now() - i, r._postInFlight = !1, r._resendAfterPost && (r._resendAfterPost = !1, r._eventQueue.length > 0 && r._sendBeaconQueue());
	});
};
...
$$2.prototype._createPayload = function(r) {
	var e = this, t = { transmission_timestamp: Math.round(P$3.now()) };
...
var hi = 3600 * 1e3, Ur = function r(e) {
	...
	S$3(this, r), l$3(this, "_lastEventTime", void 0), e.on("before*", function(i, a) {
		var n = a.viewer_time, o = P$3.now(), s = t._lastEventTime;
...
var dt$1 = Object.values(F), xe$1 = (e) => typeof e == "boolean" || typeof e == "string" && dt$1.includes(e), Ce$1 = (e, t, r) => {
	...
	if (i(), P$2(t, "loadstart", () => {
		o = !1, i(), ne$2(t, a);
	}, { once: !0 }), P$2(t, "loadstart", () => {
...
var ce$2 = {
	...
	if (s) {
		...
		return h.errorCategory = t, h.muxCode = C$3.NETWORK_OFFLINE, h.data = e, h;
	}
	...
	if (c && !p) {
		...
		return T.errorCategory = t, T.muxCode = C$3.NETWORK_TOKEN_MALFORMED, T.data = e, T;
	}
	if (i >= 500) {
		let g = new m("", u, n != null ? n : !0);
		return g.errorCategory = t, g.muxCode = C$3.NETWORK_UNKNOWN_ERROR, g;
	}
	if (i === 403) if (p) {
		if (Ee$1(p, d)) {
			let g = {
			...
			return h.errorCategory = t, h.muxCode = C$3.NETWORK_TOKEN_EXPIRED, h.data = e, h;
		}
		if (ge(p, l)) {
			...
			return T.errorCategory = t, T.muxCode = C$3.NETWORK_TOKEN_SUB_MISMATCH, T.data = e, T;
		}
		if (Me$1(p, f)) {
			...
			return T.errorCategory = t, T.muxCode = C$3.NETWORK_TOKEN_AUD_MISSING, T.data = e, T;
		}
		if (be$1(p, f)) {
			...
			return T.errorCategory = t, T.muxCode = C$3.NETWORK_TOKEN_AUD_MISMATCH, T.data = e, T;
		}
	} else {
		...
		return T.errorCategory = t, T.muxCode = C$3.NETWORK_TOKEN_MISSING, T.data = e, T;
	}
	if (i === 412) {
		...
		return T.errorCategory = t, T.muxCode = C$3.NETWORK_NOT_READY, T.streamType = r.streamType === L.LIVE ? "live" : r.streamType === L.ON_DEMAND ? "on-demand" : "unknown", T.data = e, T;
	}
	if (i === 404) {
		...
		return T.errorCategory = t, T.muxCode = C$3.NETWORK_NOT_FOUND, T.data = e, T;
	}
	if (i === 400) {
		...
		return T.errorCategory = t, T.muxCode = C$3.NETWORK_INVALID_URL, T.data = e, T;
	}
	let M = new m("", u, n != null ? n : !0);
	return M.errorCategory = t, M.muxCode = C$3.NETWORK_UNKNOWN_ERROR, M.data = e, M;
};
...
var bt$1 = "com.apple.fps.1_0", Rt = "application/vnd.apple.mpegurl", Ue = ({ mediaEl: e, getAppCertificate: t, getLicenseKey: r, saveAndDispatchError: n, drmTypeCb: o }) => {
	if (!window.WebKitMediaKeys || !("onwebkitneedkey" in e)) {
		...
		return l.errorCategory = v$1.DRM, l.muxCode = C$3.ENCRYPTED_CDM_ERROR, n(e, l), () => {};
	}
	let s = e, a = t(), i = null, d = (f) => {
		...
		try {
			...
			throw l.errorCategory = v$1.DRM, l.muxCode = C$3.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM, l;
		}
	}, y = (f) => {
		let l = s.webkitKeys.createSession(Rt, f), p = async (D) => {
			...
			T.errorCategory = v$1.DRM, T.muxCode = C$3.ENCRYPTED_CDM_ERROR, n(e, T);
		}, E = () => {
...
var He$1 = ({ mediaEl: e, getAppCertificate: t, getLicenseKey: r, saveAndDispatchError: n, drmTypeCb: o, fallbackToWebkitFairplay: s }) => {
	let a = null, i = async (c) => {
		...
		let f = await navigator.requestMediaKeySystemAccess("com.apple.fps", [{
			...
			M.errorCategory = v$1.DRM, M.muxCode = C$3.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM, n(e, M);
		});
		if (!f) return;
		...
		try {
			...
			await l.setServerCertificate(p).catch(() => {
				...
				return E.errorCategory = v$1.DRM, E.muxCode = C$3.ENCRYPTED_UPDATE_SERVER_CERT_FAILED, Promise.reject(E);
			});
		} catch (p) {
			n(e, p);
			return;
		...
		let l = e.mediaKeys.createSession(), p = async (D) => {
			...
			try {
				...
				h.errorCategory = v$1.DRM, h.muxCode = C$3.ENCRYPTED_UPDATE_LICENSE_FAILED, n(e, h);
			}
		}, M = () => {
			let D = (g) => {
				let b;
				if (g === "internal-error") b = new m(x$2("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser."), m.MEDIA_ERR_ENCRYPTED, !0), b.errorCategory = v$1.DRM, b.muxCode = C$3.ENCRYPTED_CDM_ERROR;
				else if (g === "output-restricted" || g === "output-downscaled") b = new m(x$2("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen."), m.MEDIA_ERR_ENCRYPTED, !1), b.errorCategory = v$1.DRM, b.muxCode = C$3.ENCRYPTED_OUTPUT_RESTRICTED;
				b && n(e, b);
			};
		...
		"webkitCurrentPlaybackTargetIsWireless" in e && e.addEventListener("webkitcurrentplaybacktargetiswirelesschanged", E, { once: !0 }), e.addEventListener("teardown", E, { once: !0 }), a = E, await l.generateRequest(c, f).catch(async (D) => {
			if (D.name === "NotSupportedError" && "webkitCurrentPlaybackTargetIsWireless" in e && e.webkitCurrentPlaybackTargetIsWireless) console.warn("Failed to generate a DRM license request. Attempting to fallback to Webkit DRM"), s?.();
				...
				return b.errorCategory = v$1.DRM, b.muxCode = C$3.ENCRYPTED_GENERATE_REQUEST_FAILED, console.error("Failed to generate license request", D), Promise.reject(b);
			}
		});
	}, y = async () => {
...
}, We, Ve$1, Je = (Ve$1 = (We = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : We.userAgent) != null ? Ve$1 : "", Fe, Ye, $e, Ot$1 = ($e = (Ye = (Fe = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Fe.userAgentData) == null ? void 0 : Ye.platform) != null ? $e : "", Ut$1 = Je.toLowerCase().includes("android") || ["x11", "android"].some((e) => Ot$1.toLowerCase().includes(e)), Ht$1 = (e) => /^((?!chrome|android).)*safari/i.test(Je) && !!e.canPlayType("application/vnd.apple.mpegurl"), k$2 = /* @__PURE__ */ new WeakMap(), A$1 = "mux.com", Be$1, je, ze$1 = (je = (Be$1 = R$1).isSupported) == null ? void 0 : je.call(Be$1), Kt$1 = (e) => Ut$1 || !Ht$1(e), Tn = () => {
	if (typeof window != "undefined") return jl.utils.now();
}, Wt$1 = jl.utils.generateUUID, mn = ({ playbackId: e, customDomain: t = A$1, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: s, programEndTime: a, assetStartTime: i, assetEndTime: d, playbackToken: u, tokens: { playback: y = u } = {}, extraSourceParams: c = {} } = {}) => {
	if (!e) return;
...
var zt$1 = (e, t) => {
...
}, G$2 = ({ playbackId: e, tokens: { drm: t } = {}, customDomain: r = A$1 }, n) => {
	let o = X$1(e);
	return `https://license.${r.toLocaleLowerCase().endsWith(A$1) ? r : A$1}/license/${n}/${o}?token=${t}`;
}, et = ({ playbackId: e, tokens: { drm: t } = {}, customDomain: r = A$1 }, n) => {
	let o = X$1(e);
	...
	var y, c;
	let n = Ze(e, t), { src: o, customDomain: s = A$1 } = e, a = () => {
	...
	if (P$2(t, "durationchange", u), t && n) {
		...
		if (typeof o == "string") {
			...
			if (t.preload === "none") {
				...
				P$2(t, "play", M, { once: !0 }), P$2(t, "loadedmetadata", E, { once: !0 });
			} else p();
			(y = e.tokens) != null && y.drm ? Zt$1(e, t) : P$2(t, "encrypted", () => {
				let E = new m(x$2("Attempting to play DRM-protected content without providing a DRM token."), m.MEDIA_ERR_ENCRYPTED, !0);
				E.errorCategory = v$1.DRM, E.muxCode = C$3.ENCRYPTED_MISSING_TOKEN, I$2(t, E);
		...
		}, { once: !0 }), P$2(t, "pause", a), P$2(t, "seeked", a), P$2(t, "play", () => {
		...
		Nt(l.details, t, r), u(), Ke(t) === L.LIVE && !Number.isFinite(t.duration) && (r.on(R$1.Events.LEVEL_UPDATED, u), P$2(t, "durationchange", () => {
			Number.isFinite(t.duration) && r.off(R$1.Events.LEVELS_UPDATED, u);
		}));
	}), r.on(R$1.Events.ERROR, (f, l) => {
		var M, E;
		let p = nr(l, e);
		if (p.muxCode === C$3.NETWORK_NOT_READY) {
	...
	}), t.addEventListener("error", de$3), P$2(t, "waiting", a), De(e, r), ke$1(t, r), r.attachMedia(t)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function rt(e) {
	var n;
...
var nr = (e, t) => {
	...
	} else if (i === m.MEDIA_ERR_ENCRYPTED) if (e.details === R$1.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE) a = new m(x$2("Attempting to play DRM-protected content without providing a DRM token."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_MISSING_TOKEN;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_NO_ACCESS) a = new m(x$2("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_NO_SESSION) a = new m(x$2("Failed to generate a DRM license request. This may be an issue with the player or your protected content."), m.MEDIA_ERR_ENCRYPTED, !0), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_GENERATE_REQUEST_FAILED;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_SESSION_UPDATE_FAILED) a = new m(x$2("Failed to update DRM license. This may be an issue with the player or your protected content."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_UPDATE_LICENSE_FAILED;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_UPDATE_FAILED) a = new m(x$2("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_UPDATE_SERVER_CERT_FAILED;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_STATUS_INTERNAL_ERROR) a = new m(x$2("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_CDM_ERROR;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_STATUS_OUTPUT_RESTRICTED) a = new m(x$2("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen."), m.MEDIA_ERR_ENCRYPTED, !1), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_OUTPUT_RESTRICTED;
	else a = new m(e.error.message, m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_ERROR;
...
var C$2 = (n, a, e) => a.has(n) || D$1("Cannot " + e);
var s$2 = (n, a, e) => (C$2(n, a, "read from private field"), e ? e.call(n) : a.get(n)), u$2 = (n, a, e) => a.has(n) ? D$1("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(n) : a.set(n, e), l$2 = (n, a, e, i) => (C$2(n, a, "write to private field"), i ? i.call(n, e) : a.set(n, e), e), T = (n, a, e) => (C$2(n, a, "access private method"), e);
var U$1 = () => {
	try {
		return "0.30.4";
	} catch {}
...
var t$1 = {
...
}, de$2 = Object.values(t$1), K$1 = k$1(), B$1 = "mux-video", c$2, _$1, m$5, p$4, O$1, R, I$1, M$1, g$3, y$3, o$2, f$4, S$1, b$2, Y$1 = class extends CustomVideoElement {
	constructor() {
		super();
		u$2(this, o$2);
		u$2(this, c$2);
		...
		u$2(this, y$3, (e) => {
			...
			this.metadata = {
				...i,
				...r
			}, (i == null ? void 0 : i["com.mux.video.branding"]) === "mux-free-plan" && (l$2(this, g$3, "default"), this.updateLogo());
		});
		u$2(this, S$1);
		l$2(this, _$1, Tn());
	}
	...
	get _hls() {
		var e;
		return (e = s$2(this, o$2, f$4)) == null ? void 0 : e.engine;
	}
	get mux() {
		var e;
	...
	get capRenditionToPlayerSize() {
		var e;
		return ((e = this._hlsConfig) == null ? void 0 : e.capLevelToPlayerSize) != null ? this._hlsConfig.capLevelToPlayerSize : s$2(this, S$1);
	}
	...
	get playbackToken() {
		...
		if (this.hasAttribute(t$1.PLAYBACK_ID)) {
			let [, A] = B$2((i = this.playbackId) != null ? i : "");
	...
	set metadata(e) {
		l$2(this, m$5, e != null ? e : {}), this.mux && this.mux.emit("hb", s$2(this, m$5));
	}
	get _hlsConfig() {
		return s$2(this, O$1);
	}
	...
	get logo() {
		var e;
		return (e = this.getAttribute(t$1.LOGO)) != null ? e : s$2(this, g$3);
	}
	set logo(e) {
		e ? this.setAttribute(t$1.LOGO, e) : this.removeAttribute(t$1.LOGO);
	}
	load() {
		jt$1(this, this.nativeEl, s$2(this, o$2, f$4));
	}
	unload() {
		Jt$1(this.nativeEl, s$2(this, o$2, f$4), this);
	}
	attributeChangedCallback(e, i, r) {
		...
		switch (CustomVideoElement.observedAttributes.includes(e) && ![
			...
			case "src": {
				let d = !!i, h = !!r;
				!d && h ? T(this, o$2, b$2).call(this) : d && !h ? this.unload() : d && h && (this.unload(), T(this, o$2, b$2).call(this));
				break;
			}
			case "autoplay":
				if (r === i) break;
				(A = s$2(this, o$2, f$4)) == null || A.setAutoplay(this.autoplay);
				break;
			case "preload":
				if (r === i) break;
				(P = s$2(this, o$2, f$4)) == null || P.setPreload(r);
				break;
			...
			case t$1.DISABLE_TRACKING:
				if (r == null || r !== i) {
					...
					this.unload(), T(this, o$2, b$2).call(this).then(() => {
	...
	updateLogo() {
		...
		if (!e) return;
		e.innerHTML = this.constructor.getLogoHTML(s$2(this, g$3) || this.logo);
	}
	connectedCallback() {
		var e, i;
		(e = super.connectedCallback) == null || e.call(this), (i = this.nativeEl) == null || i.addEventListener("muxmetadata", s$2(this, y$3)), this.nativeEl && this.src && !s$2(this, o$2, f$4) && T(this, o$2, b$2).call(this);
	}
	disconnectedCallback() {
		var e, i;
		(e = this.nativeEl) == null || e.removeEventListener("muxmetadata", s$2(this, y$3)), this.unload(), (i = super.disconnectedCallback) == null || i.call(this);
	}
	handleEvent(e) {
...
c$2 = /* @__PURE__ */ new WeakMap(), _$1 = /* @__PURE__ */ new WeakMap(), m$5 = /* @__PURE__ */ new WeakMap(), p$4 = /* @__PURE__ */ new WeakMap(), O$1 = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), I$1 = /* @__PURE__ */ new WeakMap(), M$1 = /* @__PURE__ */ new WeakMap(), g$3 = /* @__PURE__ */ new WeakMap(), y$3 = /* @__PURE__ */ new WeakMap(), o$2 = /* @__PURE__ */ new WeakSet(), f$4 = function() {
	return bn(this.nativeEl);
}, S$1 = /* @__PURE__ */ new WeakMap(), b$2 = async function() {
	s$2(this, c$2) || (await l$2(this, c$2, Promise.resolve()), l$2(this, c$2, null), this.load());
};
//#endregion
...
var xt = (t) => t.charAt(0).toUpperCase() + t.slice(1), ya = (t, a = !1) => {
	...
	if (t.muxCode) {
		...
		if (t.muxCode === C$3.NETWORK_OFFLINE) return x$2("Your device appears to be offline", a);
		if (t.muxCode === C$3.NETWORK_TOKEN_EXPIRED) return x$2("{category} URL has expired", a).format({ category: r });
		if ([
			C$3.NETWORK_TOKEN_SUB_MISMATCH,
			C$3.NETWORK_TOKEN_AUD_MISMATCH,
			C$3.NETWORK_TOKEN_AUD_MISSING,
			C$3.NETWORK_TOKEN_MALFORMED
		].includes(t.muxCode)) return x$2("{category} URL is formatted incorrectly", a).format({ category: r });
		if (t.muxCode === C$3.NETWORK_TOKEN_MISSING) return x$2("Invalid {categoryName} URL", a).format({ categoryName: n });
		if (t.muxCode === C$3.NETWORK_NOT_FOUND) return x$2("{category} does not exist", a).format({ category: r });
		if (t.muxCode === C$3.NETWORK_NOT_READY) {
	...
	if (t.muxCode) {
		let r = xt((e = t.errorCategory) != null ? e : "video"), n = V$1((i = t.errorCategory) != null ? i : v$1.VIDEO);
		return t.muxCode === C$3.NETWORK_OFFLINE ? x$2("Check your internet connection and try reloading this video.", a) : t.muxCode === C$3.NETWORK_TOKEN_EXPIRED ? x$2("The video’s secured {tokenNamePrefix}-token has expired.", a).format({ tokenNamePrefix: n }) : t.muxCode === C$3.NETWORK_TOKEN_SUB_MISMATCH ? x$2("The video’s playback ID does not match the one encoded in the {tokenNamePrefix}-token.", a).format({ tokenNamePrefix: n }) : t.muxCode === C$3.NETWORK_TOKEN_MALFORMED ? x$2("{category} URL is formatted incorrectly", a).format({ category: r }) : [C$3.NETWORK_TOKEN_AUD_MISMATCH, C$3.NETWORK_TOKEN_AUD_MISSING].includes(t.muxCode) ? x$2("The {tokenNamePrefix}-token is formatted with incorrect information.", a).format({ tokenNamePrefix: n }) : [C$3.NETWORK_TOKEN_MISSING, C$3.NETWORK_INVALID_URL].includes(t.muxCode) ? x$2("The video URL or {tokenNamePrefix}-token are formatted with incorrect or incomplete information.", a).format({ tokenNamePrefix: n }) : t.muxCode === C$3.NETWORK_NOT_FOUND ? "" : t.message;
	}
	...
	if (t.muxCode) {
		if (t.muxCode === C$3.NETWORK_TOKEN_EXPIRED) return "403-expired-token.md";
		if (t.muxCode === C$3.NETWORK_TOKEN_MALFORMED) return "403-malformatted-token.md";
		if ([C$3.NETWORK_TOKEN_AUD_MISMATCH, C$3.NETWORK_TOKEN_AUD_MISSING].includes(t.muxCode)) return "403-incorrect-aud-value.md";
		if (t.muxCode === C$3.NETWORK_TOKEN_SUB_MISMATCH) return "403-playback-id-mismatch.md";
		if (t.muxCode === C$3.NETWORK_TOKEN_MISSING) return "missing-signed-tokens.md";
		if (t.muxCode === C$3.NETWORK_NOT_FOUND) return "404-not-found.md";
		if (t.muxCode === C$3.NETWORK_NOT_READY) return "412-not-playable.md";
	}
	if (t.code) {
...
//# sourceMappingURL=dist-li0_wUfJ.js.map