import { n as __exportAll, r as __require, t as __commonJSMin } from "./chunk-YKewjYmz.js";
...
var require_browser_external_node_fetch = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node-fetch" has been externalized for browser compatibility. Cannot access "node-fetch.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
//#endregion
//#region node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js
var tf_core_esm_exports = /* @__PURE__ */ __exportAll({
...
function I(t, e, n) {
	if (void 0 === e && (e = []), void 0 === n && (n = !1), e ??= [], Array.isArray(t) || V(t) && !n) for (var r = 0; r < t.length; ++r) I(t[r], e, n);
	else e.push(t);
	return e;
}
function k(t) {
...
var st = Object.freeze({
	...
	function t(t, e) {
		this.backendTimer = t, this.logger = e, e ?? (this.logger = new ct());
	}
	...
	return t.prototype.flatten = function() {
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(e) {
				switch (e.label) {
					...
					case 1: return t = e.sent(), [2, xt.buffer(this.shape, this.dtype, t)];
				}
			}));
		}));
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(e) {
				switch (e.label) {
					case 0: return [4, this.data()];
					case 1: return t = e.sent(), [2, J(this.shape, t)];
				}
			}));
		}));
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(e) {
				switch (e.label) {
					case 0: return this.throwIfDisposed(), [4, yt().read(this.dataId)];
					case 1: return t = e.sent(), "string" === this.dtype ? [2, t] : [2, new Uint8Array(t.buffer)];
				}
			}));
		}));
...
Object.defineProperty(St, Symbol.hasInstance, { value: function(t) {
...
var Ot, Mt = Object.freeze({
	...
	return t.prototype.ready = function() {
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					...
					case 1: return e < t.length ? (n = t[e], [4, this.initializeBackend(n).success]) : [3, 5];
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					...
					case 1: return o = r.sent(), [3, 3];
					case 2: o = n, r.label = 3;
					case 3:
						if (!o) return [2, !1];
						r.label = 4;
					case 4: return this.backendInstance = this.registry[t], this.setupRegisteredKernels(), this.profiler = new ut(this.backendInstance), [2, !0];
				}
			}));
		}));
		...
		r ??= null != this.state.activeScope ? this.state.activeScope.name : "";
		var f, d = function(t) {
		...
		return t.numTensors = this.state.numTensors, t.numDataBuffers = this.state.numDataBuffers, t.numBytes = this.state.numBytes, this.state.numStringTensors > 0 && (t.unreliable = !0, t.reasons ??= [], t.reasons.push("Memory usage by string tensors is approximate (2 bytes per character)")), t;
		...
		return C(X(t), (function() {
			...
			return r.forEach((function(t, e) {
				...
				var o = n.gradFunc(t, e), a = Array.isArray(o) ? o : [o];
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					case 0: return e = et(), [4, this.backend.time(t)];
					case 1: return (n = r.sent()).wallMs = et() - e, [2, n];
				}
			}));
		}));
...
var Lt = function() {
	...
	if (null == t._tfengine) t._tfengine = new Pt(new o(t));
	return function(t) {
		s = t;
...
function ne(t, e) {
	switch (e) {
		case t.NO_ERROR: return "NO_ERROR";
		case t.INVALID_ENUM: return "INVALID_ENUM";
		case t.INVALID_VALUE: return "INVALID_VALUE";
		case t.INVALID_OPERATION: return "INVALID_OPERATION";
		case t.INVALID_FRAMEBUFFER_OPERATION: return "INVALID_FRAMEBUFFER_OPERATION";
		case t.OUT_OF_MEMORY: return "OUT_OF_MEMORY";
		case t.CONTEXT_LOST_WEBGL: return "CONTEXT_LOST_WEBGL";
		default: return "Unknown error code " + e;
	}
}
function re(t, e, n) {
...
function oe(t, e, n) {
	...
	})), !1 === t.getShaderParameter(r, t.COMPILE_STATUS)) throw console.log(t.getShaderInfoLog(r)), /* @__PURE__ */ new Error("Failed to compile vertex shader.");
	return r;
}
function ae(t, e, n) {
	var r = ke(t, e, (function() {
	...
	}(n, t.getShaderInfoLog(r)), /* @__PURE__ */ new Error("Failed to compile fragment shader.");
	return r;
}
...
function le(t, e, n) {
	...
	})), !1 === t.getProgramParameter(n, t.LINK_STATUS)) throw console.log(t.getProgramInfoLog(n)), /* @__PURE__ */ new Error("Failed to link vertex and fragment shaders.");
}
function he(t, e, n) {
	if (Jt(t, e, (function() {
		return t.validateProgram(n);
	})), !1 === t.getProgramParameter(n, t.VALIDATE_STATUS)) throw console.log(t.getProgramInfoLog(n)), /* @__PURE__ */ new Error("Shader program validation failed.");
}
function fe(t, e, n) {
	var r = ke(t, e, (function() {
...
function Ie(t, e) {
	switch (e) {
		case t.FRAMEBUFFER_INCOMPLETE_ATTACHMENT: return "FRAMEBUFFER_INCOMPLETE_ATTACHMENT";
		case t.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT: return "FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT";
		case t.FRAMEBUFFER_INCOMPLETE_DIMENSIONS: return "FRAMEBUFFER_INCOMPLETE_DIMENSIONS";
		case t.FRAMEBUFFER_UNSUPPORTED: return "FRAMEBUFFER_UNSUPPORTED";
...
function Ne(t, e) {
	...
	}))).length && (t = [2, t[0]])), 2 !== t.length) t = M(t).newShape;
	var a = k(t);
...
function Ue(t) {
	...
	if (1 !== t) {
		...
		if (Pe(e, "EXT_color_buffer_half_float")) return function(t, e) {
		...
		}(e, e.getExtension("EXT_color_buffer_half_float"));
		return !1;
	}
...
var Dn = An({ complex_: function(t, e) {
...
function _n(t, e, n, r) {
	if (r ??= j(t), "complex64" === r) throw new Error("Cannot construct a complex64 tensor directly. Please use tf.complex(real, imag).");
...
function zn(t, e) {
	if (void 0 === e && (e = "float32"), "complex64" === e) return Dn(zn(t, "float32"), Gn(t, "float32"));
	var o = Z(k(t), e);
	return Lt.makeTensor(o, t, e);
}
function Gn(t, e) {
	if (void 0 === e && (e = "float32"), "complex64" === e) return Dn(Gn(t, "float32"), Gn(t, "float32"));
	var o = tt(k(t), e);
	return Lt.makeTensor(o, t, e);
}
function Hn(t, e, n) {
...
var jn = An({ onesLike_: function(t) {
	...
	if ("complex64" === e.dtype) return Dn(jn(Tn(e)), Xn(Nn(e)));
	return Lt.runKernelFunc((function(t) {
		return t.onesLike(e);
	}), { $x: e }, (function(t, e) {
		return { $x: function() {
...
var nr = er((function(t) {
	(function(t, e, n) {
		function r(t) {
			var e, n = this, r = (e = 4022871197, function(t) {
				...
				return 23283064365386963e-26 * (e >>> 0);
			});
			n.next = function() {
	...
	(function(e, n) {
		...
		if (n["seed" + s] = f, v(n.random(), e), t.exports) {
			t.exports = f;
			try {
				r = require_browser_external_crypto();
			} catch (t) {}
		}
	})([], Math);
}));
...
var cr = ur.alea, lr = function() {
	function t(t, e, n, r, o) {
		...
		this.random = cr((o || Math.random()).toString());
	}
	...
	function t(t, e, n, r) {
		...
		this.randu = cr((r || Math.random()).toString()), this.randn = new lr(0, 1, n, !1, this.randu()), this.d = t < 1 ? t + 2 / 3 : t - 1 / 3, this.c = 1 / Math.sqrt(9 * this.d);
	}
	return t.prototype.nextValue = function() {
		for (var t, e, n, r, o, a;;) {
			do
	...
	function t(t, e, n, r) {
		...
		}, this.min = t, this.range = e - t, this.dtype = n, r ??= Math.random(), "number" == typeof r && (r = r.toString()), !this.canReturnFloat() && this.range <= 1) throw new Error("The difference between " + t + " - " + e + " <= 1 and dtype is not float");
		this.random = cr(r);
	}
...
var vr = An({ batchToSpaceND_: function(t, e, n) {
	...
	var o = mn(t, "x", "cumsum"), a = En([e |= 0], o.rank), i = o;
	...
	var o = mn(t, "indices", "oneHot", "int32"), a = o.shape.concat([e]);
	...
	if (void 0 === n && (n = 1), void 0 === r && (r = "float32"), n ??= 1, r ??= "float32", "float32" !== r && "int32" !== r) throw new Error("Unsupported data type " + r);
	...
	return n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				case 0: return n = mn(t, "x", "setdiff1d"), o = mn(e, "y", "setdiff1d"), C(n.dtype === o.dtype, (function() {
				...
				case 1: return a = r.sent(), [4, o.data()];
				case 2:
...
function _o(t, e) {
	...
	switch (e) {
		...
		default: throw new Error("Unknown roundingMode " + e);
	}
}
function Oo(t) {
...
function na(t, e) {
	...
	var o = dr(t, "int32"), a = dr([n.length, t.length], "int32");
...
function fa(t, e, n, r) {
	...
	return e.isPacked ? (a = function(t, e) {
		switch (t.length) {
			...
			case 3: return n = t, r = e, o = [Math.ceil(r[0] / 2), Math.ceil(r[1] / 2)], a = Math.ceil(n[2] / 2), i = a * Math.ceil(n[1] / 2), "\n    ivec3 getOutputCoords() {\n      ivec2 resTexRC = ivec2(resultUV.yx *\n                             vec2(" + o[0] + ", " + o[1] + "));\n      int index = resTexRC.x * " + o[1] + " + resTexRC.y;\n\n      int b = index / " + i + ";\n      index -= b * " + i + ";\n\n      int r = 2 * (index / " + a + ");\n      int c = imod(index, " + a + ") * 2;\n\n      return ivec3(b, r, c);\n    }\n  ";
			default: return function(t, e) {
		...
		switch (t.length) {
			...
			default: throw new Error(t.length + "-D output sampling is not yet supported");
		}
		var n, r;
	}(e.logicalShape, c), i = function(t) {
...
function da(t) {
	...
	switch (e.length) {
		...
		default: throw new Error(e.length + "-D input sampling is not yet supported");
	}
}
function pa(t) {
	var e, n, r;
	switch (t.shapeInfo.logicalShape.length) {
		case 0: return e = t.name, n = "get" + e.charAt(0).toUpperCase() + e.slice(1), r = ua(), "\n    vec4 " + n + "() {\n      return " + r.texture2D + "(" + e + ", halfCR);\n    }\n  ";
		case 1: return function(t) {
			var e = t.name, n = "get" + e.charAt(0).toUpperCase() + e.slice(1), r = t.shapeInfo.texShape, o = [Math.ceil(r[0] / 2), Math.ceil(r[1] / 2)], a = ua();
		...
		case 3: return function(t) {
			var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = t.shapeInfo.texShape, a = [Math.ceil(o[0] / 2), Math.ceil(o[1] / 2)];
...
var Ra = function(t, e, n, r) {
	...
	return t.prototype.getCustomSetupFunc = function(t, e) {
		var n = this;
		return function(r, o) {
			n.minLoc ?? (n.minLoc = r.getUniformLocationNoThrow(o, "minVal"), n.maxLoc = r.getUniformLocationNoThrow(o, "maxVal")), r.gl.uniform1f(n.minLoc, t), r.gl.uniform1f(n.maxLoc, e);
		};
	}, t;
}(), Ua = function() {
	function t(t) {
...
var qa = function(t) {
	...
	var f = "bilinear" === r ? 1 : 0, d = [i - 1 + ".0", s - 1 + ".0"], p = d[0], v = d[1], m = l > 1 ? [
		"" + (i - 1) / (l - 1),
		"(y2-y1) * height_ratio",
...
var oi = function(t) {
	...
	return t.prototype.getCustomSetupFunc = function(t) {
		var e = this;
		return function(n, r) {
			e.valueLoc ??= n.getUniformLocationNoThrow(r, "value"), n.gl.uniform1f(e.valueLoc, t);
		};
	}, t;
}(), mi = function(t, e, n) {
...
var Mi = Object.freeze({
	...
	return Object.defineProperty(t.prototype, "debug", {
		...
		return this.disjointQueryTimerExtension ??= re(this.gl, this.debug, 2 === i().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") ? "EXT_disjoint_timer_query_webgl2" : "EXT_disjoint_timer_query"), this.disjointQueryTimerExtension;
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(n) {
				switch (n.label) {
					case 0: return [4, F((function() {
						return e.disposed || e.isQueryAvailable(t, i().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION"));
					}))];
					case 1: return n.sent(), [2, this.getQueryTime(t, i().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION"))];
				}
			}));
		}));
		...
		if (2 === e) {
			...
			return this.disjoint ??= this.gl.getParameter(r.GPU_DISJOINT_EXT), o && !this.disjoint;
		}
...
var Li = function(t, e, n) {
	...
	var s = n ? t[1] : t[2], u = Math.ceil(s / 2), c = n ? "i * 2, rc.y" : "rc.y, i * 2", l = r ? "rc.z, i * 2" : "i * 2, rc.z", h = n ? ["a.xxyy", "a.zzww"] : ["a.xxzz", "a.yyww"], f = r ? ["b.xzxz", "b.ywyw"] : ["b.xyxy", "b.zwzw"], d = "", p = "";
	...
	return t.prototype.getCustomSetupFunc = function(t) {
		var e = this;
		return function(n, r) {
			e.seedLoc ??= n.getUniformLocation(r, "seed"), n.gl.uniform1f(e.seedLoc, t);
		};
	}, t;
}(), Ki = function(t, e, n, r) {
...
var Xi = function(t, e, n) {
	...
	var n = t.windowSize, r = t.batchSize, o = t.inSize;
	this.outputShape = [r, Math.ceil(o / n)];
	var i = "0.0", s = "";
...
var ts = function(t, e, n) {
	...
	var r = e.shape, o = r[1], a = r[2], i = t.shape, s = i[1], u = i[2], c = [n && s > 1 ? o - 1 : o, n && u > 1 ? a - 1 : a], l = [n && s > 1 ? s - 1 : s, n && u > 1 ? u - 1 : u], h = c[0] / l[0], f = c[1] / l[1], d = 1 / h, p = 1 / f, v = 2 * Math.ceil(d) + 2, m = 2 * Math.ceil(p) + 2;
	...
	var u = [r && e > 1 ? a - 1 : a, r && n > 1 ? i - 1 : i], c = [r && e > 1 ? e - 1 : e, r && n > 1 ? n - 1 : n];
	...
	var u = [r && e > 1 ? a - 1 : a, r && n > 1 ? i - 1 : i], c = [r && e > 1 ? e - 1 : e, r && n > 1 ? n - 1 : n], l = r ? "0.5" : "0.0";
	...
	var n = t.windowSize, r = t.batchSize, o = t.inSize, a = t.numSegments;
	this.outputShape = [r, a * Math.ceil(o / n)];
...
var Zs = function(t) {
	function o(e) {
		...
		if (r.pendingRead = /* @__PURE__ */ new WeakMap(), r.pendingDisposal = /* @__PURE__ */ new WeakSet(), r.dataRefCount = /* @__PURE__ */ new WeakMap(), r.numBytesInGPU = 0, r.uploadWaitMs = 0, r.downloadWaitMs = 0, r.warnedAboutMemory = !1, r.pendingDeletes = 0, r.disposed = !1, !i().getBool("HAS_WEBGL")) throw new Error("WebGL is not supported on this device");
		if (null == e) {
	...
	return e(o, t), o.prototype.numDataIds = function() {
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					...
					case 2: return "complex64" !== u ? [3, 4] : [4, Promise.all([c.real.data(), c.imag.data()])];
					case 3: return y = r.sent(), x = y[0], b = y[1], g = Vo(x, b), [3, 5];
					case 4: null == p ? g = this.getValuesFromTexture(t) : (w = k(a), g = this.gpgpu.downloadFloat32MatrixFromBuffer(p, w)), r.label = 5;
					case 5: return null != v && this.disposeData(v.dataId), C = this.convertAndCacheOnCPU(t, g), E = this.pendingRead.get(t), this.pendingRead.delete(t), E.forEach((function(t) {
						return t(C);
		...
		if (i().getBool("WEBGL_DOWNLOAD_FLOAT_ENABLED")) {
			var u = this.decode(t), c = this.texData.get(u.dataId), l = (e = this.gpgpu).downloadMatrixFromPackedTexture.apply(e, [c.texture].concat(Yt(r))).subarray(0, s);
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					case 0: return e = this.activeTimers, n = [], o = !1, null == this.programTimersStack ? (this.programTimersStack = n, o = !0) : this.activeTimers.push(n), this.activeTimers = n, t(), a = I(this.activeTimers.map((function(t) {
						return t.query;
					}))).filter((function(t) {
						return null != t;
					...
					case 1: return c = r.sent(), u.kernelMs = w(c), u.getExtraProfileInfo = function() {
					...
					case 2: u.kernelMs = { error: "WebGL query timers are not supported in this environment." }, r.label = 3;
					case 3: return this.uploadWaitMs = 0, this.downloadWaitMs = 0, [2, u];
				}
			}));
		}));
		...
		return i().getBool("WEBGL_CPU_FORWARD") ? (this.cpuBackend ??= Lt.findBackend("cpu"), this.cpuBackend) : null;
		...
		var r = t.shape[0], o = t.shape[1], i = new Ji({
			windowSize: $r(o),
			inSize: o,
			batchSize: r
		}, e), s = this.compileAndRun(i, [t], n);
		...
		void 0 === n && (n = null);
		var r = null != n ? n.shape : t.shape, a = new Ra(r, $r(r[r.length - 1]), e, null == n), i = null == n ? [t] : [t, n], s = this.compileAndRun(a, i, "int32");
		...
		var r = 0, o = En([r], t.rank), a = t;
		null != o && (a = t.transpose(o), r = In(1, t.rank)[0]);
		var i = function(t, e, n) {
			for (var r = [], o = t.length, a = 0; a < o; a++) a !== e ? r.push(t[a]) : r.push(n);
			return r;
		}(a.shape, r, n), s = k([a.shape[r]]), u = a.as2D(-1, s), c = Tt(t.dtype), l = this.segOpCompute(u, "unsortedSegmentSum", e, c, n).reshape(i);
		...
		var a = t.shape[0], i = t.shape[1], s = function(t, e) {
			...
			batchSize: a,
			numSegments: o
		}, e), c = this.compileAndRun(u, [t, n], r);
		...
		var r = this, o = this.texData.get(t.dataId), a = this.texData.get(e.dataId), i = [[o.complexTensors.real, a.complexTensors.real], [o.complexTensors.imag, a.complexTensors.imag]].map((function(o) {
		...
		var n = O([e], t.shape), r = this.max(t, n), o = wn(r.shape, n), a = this.subtract(t, r.reshape(o)), i = this.exp(a), s = this.sum(i, n).reshape(o);
		...
		var e = this.texData.get(t.dataId), n = new Va(t.shape), r = [this.makeComplexComponentTensorInfo(t, e.complexTensors.real), this.makeComplexComponentTensorInfo(t, e.complexTensors.imag)];
		...
		var i = n.filterWidth, s = n.filterHeight, u = n.inChannels, c = n.outWidth, l = n.outHeight, h = "channelsLast" === n.dataFormat, f = i * s * u, d = l * c, p = [f, d], v = t.squeeze([0]), m = e.reshape([
			1,
			f,
			-1
		]), g = new Li(p, v.shape, n), y = this.compileAndRun(g, [v]).reshape([
			1,
			p[0],
			p[1]
		...
		var u = null != o, c = null != s, h = new Qa(r, u, a ? Qs(a, !1) : null, c), f = [e, n];
		...
		var e, n = t.input, r = t.filter, o = t.convInfo, a = t.bias, s = t.activation, u = t.preluActivationWeights, c = i().getBool("WEBGL_PACK_DEPTHWISECONV") && o.strideWidth <= 2 && o.outChannels / o.inChannels == 1, l = s ? Qs(s, c) : null, h = [n, r], f = null != a, d = null != u;
		...
		var o = new $i(r, "max", !0), a = this.compileAndRun(o, [e]), i = new zi(r), s = this.compileAndRun(i, [t, a], e.dtype);
		return a.dispose(), s;
		...
		var o = new Qi(r, "max", !0), a = this.compileAndRun(o, [e]), i = new Gi(r), s = this.compileAndRun(i, [t, a], e.dtype);
		return a.dispose(), s;
		...
		var r = Zr(0, t, n), o = r.sliceRank, a = r.numUpdates, i = r.sliceSize, s = r.strides, u = r.outputSize, c = [u / i, i], l = t.reshape([a, o]), h = e.reshape([a, i]);
		...
		var o = Zr(0, t, n), a = o.sliceRank, i = o.numUpdates, s = o.strides, u = o.outputSize, c = new ss(i, a, t.rank, e.rank, s, [u, 1], !1);
		...
		var n = this.texData.get(t.dataId), r = new pi(fi, t.shape, e), o = new pi(di, t.shape, e), a = [this.makeComplexComponentTensorInfo(t, n.complexTensors.real), this.makeComplexComponentTensorInfo(t, n.complexTensors.imag)], i = this.compileAndRun(r, a), s = this.compileAndRun(o, a), u = this.complex(i, s).as2D(t.shape[0], t.shape[1]);
		return i.dispose(), s.dispose(), u;
	}, o.prototype.gatherND = function(t, e) {
		var n = e.shape, r = n[n.length - 1], o = jr(t, e), a = o[0], i = o[1], s = o[2], u = o[3], c = e.reshape([i, r]), l = t.reshape([t.size / s, s]), h = new gi(r, u, [i, s]);
		...
		var n = [Ae(t.shape)].concat(De(t.shape)), r = {
			dtype: t.dtype,
			shape: n,
			dataId: t.dataId
		}, a = new Zi([Ae(e)].concat(De(e)), n), i = this.runWebGLProgram(a, [r], t.dtype, null, !0);
		return {
			dataId: i.dataId,
			shape: e,
			dtype: i.dtype
		...
		if (t.packedOutput && (u.isPacked = !0), t.outPackingScheme === Vt.DENSE) u.texShape = Yt(t.outputShape).map((function(t) {
			return 2 * t;
		}));
		...
		if (m && (f = this.startTimer()), function(t, e, n, r, o) {
			...
			r.texData.isPacked ? t.setOutputPackedMatrixTexture(a, s[0], s[1]) : t.setOutputMatrixTexture(a, s[0], s[1]), t.setProgram(e.webGLProgram), 1 === i().getNumber("WEBGL_VERSION") && null !== e.infLoc && t.gl.uniform1f(e.infLoc, Infinity), null !== e.nanLoc && t.gl.uniform1f(e.nanLoc, NaN), n.forEach((function(n, r) {
			...
			})), o?.(t, e.webGLProgram), t.executeProgram();
		...
		var t = this;
		return this.floatPrecisionValue ??= Ze((function() {
		...
		if (null == i) {
			...
			l && (c = et());
			var h = n.texShape;
			if (h ?? (h = Ne(r, u), n.texShape = h), null != a) {
				...
				var y = this.runWebGLProgram(d, [g], o, null, !0), x = this.texData.get(y.dataId);
			...
			} else n.texture = this.acquireTexture(h, s, o, u);
		}
...
var tu = An({ square_: function(t) {
	var e = mn(t, "x", "square"), n = [e];
	return Lt.runKernelFunc((function(t, n) {
		return n([e]), t.square(e);
	}), { x: e }, null, "Square", {}, n, []);
} }), eu = "SquaredDifference";
var nu = An({ squaredDifference_: function(t, e) {
...
var Qu = An({ logicalAnd_: function(t, e) {
	...
	return n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				case 0: return [4, (e = mn(t, "condition", "whereAsync", "bool")).data()];
				case 1: return n = r.sent(), o = na(e.shape, n), t !== e && e.dispose(), [2, o];
			}
		}));
	}));
};
var rc = An({ add_: function(t, e) {
	...
	n = Nt(r, o), r = n[0], o = n[1];
	var a = Ro(r.shape, o.shape), i = [r, o];
	return Lt.runKernelFunc((function(t, e) {
		var n = t.pow(r, o);
		return e([
			r,
...
var Lc = An({ gather_: function(t, e, n) {
		...
		return {
			x: function() {
				var e = r.shape, a = o.size, i = e.slice(0, n), s = i.length, u = e.slice(n, e.length).slice(1), c = u.length, l = Bc(0, s), h = Bc(s + 1, s + 1 + c), f = Pc([
					...
					[a],
					u
				]), d = t.reshape(f), p = o.reshape([a]), v = Pc([
					[s],
					l,
					h
				]), g = Wc(d.transpose(v), p, r.shape[n]), y = Rn(v);
	...
	return C(A(n), (function() {
		...
		return { $x: function() {
			return function(t, e) {
				for (var r = Lc(t, hc(e, Xn(e))), o = Sc(e, On(0, "int32")), a = r.rank - o.rank, i = 0; i < a; ++i) o = wr(o, i + 1);
	...
	return n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				...
				case 1: return p = r.sent(), v = p.squeeze([1]), m = Lc(f, v, i), t !== n && n.dispose(), e !== a && a.dispose(), v.dispose(), f.dispose(), d.dispose(), p.dispose(), [2, m];
			}
		}));
	}));
};
...
var Hc = An({ conv1d_: function(t, e, n, r, o, a, i) {
	...
	var h = u.as4D(1, u.shape[0], u.shape[1], u.shape[2]), d = qc(c.as4D(c.shape[0], 1, c.shape[1], c.shape[2]), h, [1, n], r, "NHWC", [1, a], i);
	...
	var f = Bo(o), d = So(c.shape, u.shape, n, a, r, i, !1, f), p = [u, c], v = Lt.runKernelFunc((function(t, e) {
...
} }), Xc = An({ conv2dDerInput_: Vc }), Yc = An({ depthwiseConv2d_: function(t, e, n, r, o, a, i) {
	void 0 === o && (o = "NHWC"), void 0 === a && (a = [1, 1]);
	...
	var h = So(c.shape, u.shape, n, a, r, i, !0), f = [c, u], d = Lt.runKernelFunc((function(t, e) {
	...
	var v = qc(Yc(l, u, r, o, i, a), c, 1, "valid", i);
...
var el = An({ matMul_: function(t, e, n, r) {
	...
	var v = a.shape.slice(0, -2).concat([c, l]), m = n ? a.as3D(d, s, c) : a.as3D(d, c, s), g = r ? i.as3D(p, l, u) : i.as3D(p, u, l), y = {
		transposeA: n,
		transposeB: r
	};
	return Lt.runKernelFunc((function(t, e) {
...
function cl(t, e, n, r, o, a) {
	...
	3 === i.rank && (u = !0, s = i.as4D(1, i.shape[0], i.shape[1], i.shape[2])), r ??= [1, 1], C(4 === s.rank, (function() {
	...
	var l = [s], h = Lt.runKernelFunc((function(t, e) {
		var n = t.maxPool(s, c);
		return e([s, n]), n;
	}), { x: s }, (function(t, a) {
		var i = a[0], s = a[1];
...
var hl = An({ maxPool_: function(t, e, n, r, o) {
	...
	var c, l = Io(s.shape, e, a, o, r), h = [l.dilationHeight, l.dilationWidth];
	...
	}([l.inHeight, l.inWidth], h, c), p = d[0], v = d[1], m = f ? r : "valid", g = f ? s : Mr(s, h, p), y = ("avg" === n ? function() {
		return ll(g, e, a, 1, m);
	} : function() {
		return cl(g, e, a, 1, m);
	})(), x = f ? y : vr(y, h, v);
	...
	4 === s.rank && (c = !0, u = s.as5D(1, s.shape[0], s.shape[1], s.shape[2], s.shape[3])), i ??= [
		1,
		1,
		1
	], C(5 === u.rank, (function() {
...
var Cl = An({ all_: function(t, e, n) {
	...
	var u = [r], c = Lt.runKernelFunc((function(t, e) {
		var n = t.max(r, i);
		return e([o, n]), n;
	}), { x: r }, (function(t, e) {
	...
	return {
		mean: o,
		variance: t.toFloat().sub(o.reshape(a)).square().mean(r, n)
	};
	...
	return vo((function(t) {
		...
		}, s = { axes: r }, u = Lt.runKernelFunc((function(t) {
			return t.sum(a, r);
		}), { x: a }, (function(t) {
			return { x: function() {
				return i(t);
...
var _l = An({ elu_: function(t) {
	...
	return Lt.runKernelFunc((function(t, n) {
		...
		var n = e[0];
		return { $x: function() {
			var e = n.greater(On(0)), r = On(bs), o = On(ws);
			return ec(e, t.mul(o), t.mul(r).mul(n.toFloat().exp()));
		} };
	}));
} });
var Wl = An({ transpose_: function(t, e) {
	var n = mn(t, "x", "transpose");
	if (e ??= n.shape.map((function(t, e) {
		return e;
...
var Vl = An({ norm_: function(t, e, n, r) {
	...
	var o = function t(e, n, r) {
		...
		if (1 === e.rank || "number" == typeof r || Array.isArray(r) && 1 === r.length) {
			...
			if (n === Infinity) return e.abs().max(r);
			if (n === -Infinity) return e.abs().min(r);
		...
		if (Array.isArray(r) && 2 === r.length) {
			...
			if (n === Infinity) return e.abs().sum(r[1]).max(r[0]);
			if (n === -Infinity) return e.abs().sum(r[1]).min(r[0]);
...
var zl = An({ basicLSTMCell_: function(t, e, n, r, o, a) {
	var i = mn(t, "forgetBias", "basicLSTMCell"), s = mn(e, "lstmKernel", "basicLSTMCell"), u = mn(n, "lstmBias", "basicLSTMCell"), c = mn(r, "data", "basicLSTMCell"), l = mn(o, "c", "basicLSTMCell"), h = mn(a, "h", "basicLSTMCell"), f = c.concat(h, 1).matMul(s).add(u), d = f.shape[0], p = f.shape[1] / 4, v = [d, p], m = f.slice([0, 0], v), g = f.slice([0, p], v), y = f.slice([0, 2 * p], v), x = f.slice([0, 3 * p], v), b = m.sigmoid().mulStrict(g.tanh()).addStrict(l.mulStrict(i.add(y).sigmoid()));
...
var ql = An({ stridedSlice_: function(t, e, n, r, o, a, i, s, u) {
	if (void 0 === o && (o = 0), void 0 === a && (a = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === u && (u = 0), r ??= new Array(e.length), 0 !== i) throw new Error("ellipsis mask is not yet supported");
...
var Xl = An({ fft_: function(t) {
	...
	var u = n.zerosLike(), l = Xl(Dn(n, u).as2D(o, r)), h = Math.floor(r / 2) + 1, f = Tn(l), d = Nn(l), p = f.split([h, r - h], f.shape.length - 1), v = d.split([h, r - h], d.shape.length - 1), m = n.shape.slice();
	...
	var a = [n, 2 * (e - 1)], i = Tn(t).as2D(n, e), s = Nn(t).as2D(n, e), u = i.slice([0, 1], [n, e - 2]).reverse(1), c = s.slice([0, 1], [n, e - 2]).reverse(1).mul(On(-1));
	return r = Dn(i.concat(u, 1), s.concat(c, 1)).as2D(a[0], a[1]), o = Yl(r), Tn(o);
} }), Jl = Object.freeze({
	fft: Xl,
	ifft: Yl,
	rfft: $l,
...
var Zl = An({ sparseToDense_: function(t, e, n, r) {
	void 0 === r && (r = 0);
...
var oh = An({ hannWindow_: function(t) {
	...
	if (r) for (; a < t.size;) {
		var s = a + e - t.size, u = Yn([ml(t, a, e - s), Hn([s], o)]);
		i.push(u), a += n;
	}
	return 0 === i.length ? Bn([], [0, e]) : Yn(i).as2D(i.length, e);
} }), sh = An({ stft_: function(t, e, n, r, o) {
	var a;
	void 0 === o && (o = oh), r ?? (a = e, r = Math.floor(Math.pow(2, Math.ceil(Math.log(a) / Math.log(2)))));
...
var ch, lh = function(t, e, o) {
	return void 0 === o && (o = 1), n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				case 0: return n = mn(t, "predictions", "inTopK"), a = mn(e, "targets", "inTopK"), C(n.rank > 1, (function() {
				...
				case 1: return s = r.sent(), [4, a.data()];
				case 2:
...
var hh = An({ absoluteDifference_: function(t, e, n, r) {
	...
	return fh(On(1).sub(a.mul(i).sum(n, !0)), s, o);
	...
	var s = On(1);
	o = On(2).mul(o).sub(s);
	return fh(s.sub(o.mul(a)).relu(), i, r);
	...
	var u = On(r), c = i.sub(a).abs(), l = dc(c, u), h = c.sub(l);
	return fh(On(.5).mul(l.square()).add(u.mul(h)), s, o);
	...
	var u = On(1), c = On(r);
	return fh(a.mul(i.add(c).log()).neg().sub(u.sub(a).mul(u.sub(i).add(c).log())), s, o);
	...
	return fh(o.squaredDifference(a), i, r);
	...
	return fh(function(t, e, n) {
		...
		return vo((function(t, e, r) {
			var o = e.logSumExp([n], !0), a = e.toFloat().sub(o);
			r([t, a]);
			return {
				value: a.mul(t).neg().sum([n]),
				gradFunc: function(t, e) {
					var r = e[0], o = e[1], a = wn(t.shape, [n]);
...
function wh(t, e) {
	return void 0 === e && (e = !1), Lt.tidy((function() {
		...
		for (var n = t.shape[0], r = t.shape[1], o = Cr(n), a = t.clone(), i = Bn([[1]], [1, 1]), s = i.clone(), u = n >= r ? r : n, c = function(t) {
			var e, u = a, c = s, l = o;
			e = Lt.tidy((function() {
				var e = a.slice([t, t], [n - t, 1]), u = e.norm(), c = a.slice([t, t], [1, 1]), l = Bn([[-1]]).where(c.greater(0), Bn([[1]])), h = c.sub(l.mul(u)), f = e.div(h);
				s = 1 === f.shape[0] ? i.clone() : i.concat(f.slice([1, 0], [f.shape[0] - 1, f.shape[1]]), 0);
				var d = l.matMul(h).div(u).neg(), p = a.slice([t, 0], [n - t, r]), v = d.mul(s);
...
var Ch = An({ bandPart_: function(t, e, n) {
	...
	e < 0 && (e = i), n < 0 && (n = s);
	var l = Cc(Kn(0, i, 1, "int32").reshape([-1, 1]), Kn(0, s, 1, "int32")), h = Qu(l.lessEqual(On(+e, "int32")), l.greaterEqual(On(-n, "int32"))), f = Gn([i, s], r.dtype);
...
function kh(t, e, n, r, o, a) {
	r ??= .5, o ??= Number.NEGATIVE_INFINITY, a ??= 0;
	var i = t.shape[0];
...
var Sh = An({ resizeBilinear_: function(t, e, n) {
	...
	return void 0 === a && (a = .5), void 0 === i && (i = Number.NEGATIVE_INFINITY), n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				case 0: return n = mn(t, "boxes", "nonMaxSuppressionAsync"), s = mn(e, "scores", "nonMaxSuppressionAsync"), u = kh(n, s, o, a, i), o = u.maxOutputSize, a = u.iouThreshold, i = u.scoreThreshold, [4, Promise.all([n.data(), s.data()])];
				case 1: return c = r.sent(), l = c[0], h = c[1], f = jo(l, h, o, a, i), n !== t && n.dispose(), s !== e && s.dispose(), [2, f];
			}
		}));
	}));
	...
	return void 0 === a && (a = .5), void 0 === i && (i = Number.NEGATIVE_INFINITY), void 0 === s && (s = 0), n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				case 0: return n = mn(t, "boxes", "nonMaxSuppressionAsync"), u = mn(e, "scores", "nonMaxSuppressionAsync"), c = kh(n, u, o, a, i, s), o = c.maxOutputSize, a = c.iouThreshold, i = c.scoreThreshold, s = c.softNmsSigma, [4, Promise.all([n.data(), u.data()])];
				case 1: return l = r.sent(), h = l[0], f = l[1], d = Xo(h, f, o, a, i, s), n !== t && n.dispose(), u !== e && u.dispose(), [2, d];
			}
		}));
	}));
...
var Wh = An({ fusedMatMul_: function(t) {
	...
	var R, I, A = d.shape.slice(0, -2).concat([g, y]), D = a ? d.as3D(w, v, g) : d.as3D(w, g, v), T = s ? p.as3D(E, y, m) : p.as3D(E, m, y);
	...
	var e = t.x, n = t.filter, r = t.strides, o = t.pad, a = t.dataFormat, i = void 0 === a ? "NHWC" : a, s = t.dilations, u = void 0 === s ? [1, 1] : s, c = t.dimRoundingMode, l = t.bias, h = t.activation, f = void 0 === h ? "linear" : h, d = t.preluActivationWeights;
	...
	var R = [m, g], I = Lt.runKernelFunc((function(t, e) {
		var n = t.fusedConv2d({
			input: g,
			filter: m,
			convInfo: w,
...
var Kh = function(t) {
	...
	return e(o, t), o.prototype.write = function(t, e, n) {
		...
		return Fn(s, Sn(t.map((function(t) {
			return t.shape;
		})), e), t[0].dtype);
	}, o.prototype.neg = function(t) {
		...
		for (a = 0; a < n; ++a) {
			var s = Rc(On(a, "int32"), e).asType("float32").mul(t).sum(0);
			r.push(s);
		}
		return Pr(r);
	}, o.prototype.argMin = function(t, e) {
		...
		Hh(t, "x");
		for (var e = this.readSync(t.dataId), n = new Uint8Array(e.length), r = 0; r < e.length; ++r) Math.abs(e[r]) === Infinity && (n[r] = 1);
		return this.makeOutput(n, t.shape, "bool");
	}, o.prototype.isFinite = function(t) {
		Hh(t, "x");
		...
		for (var r = dr(n.inShape, "float32"), o = r.values, a = this.readSync(t.dataId), i = this.readSync(e.dataId), s = e.strides, u = s[0], c = s[1], l = s[2], h = n.batchSize, f = n.filterHeight, d = n.filterWidth, p = n.inChannels, v = n.inHeight, m = n.inWidth, g = n.outChannels, y = n.outHeight, x = n.outWidth, b = n.strideHeight, w = n.strideWidth, C = n.dataFormat, E = f - 1 - n.padInfo.top, R = d - 1 - n.padInfo.left, I = "channelsLast" === C, k = r.strides[0], S = I ? r.strides[1] : r.strides[2], A = I ? r.strides[2] : 1, D = I ? 1 : r.strides[1], T = t.strides[0], N = I ? t.strides[1] : t.strides[2], F = I ? t.strides[2] : 1, _ = I ? 1 : t.strides[1], O = 0; O < h; ++O) for (var M = 0; M < p; ++M) for (var B = 0; B < v; ++B) for (var P = B - E, L = Math.max(0, Math.ceil(P / b)), W = Math.min(y, (f + P) / b), U = 0; U < m; ++U) {
			for (var V = U - R, z = Math.max(0, Math.ceil(V / w)), G = Math.min(x, (d + V) / w), H = 0, q = L; q < W; ++q) for (var K = q * b - P, j = z; j < G; ++j) for (var X = T * O + N * q + F * j, Y = u * (f - 1 - K) + c * (d - 1 - (j * w - V)) + l * M, $ = 0; $ < g; ++$) H += a[X + _ * $] * i[Y + $];
			o[k * O + S * B + A * U + D * M] = H;
		}
		return r.toTensor();
	}, o.prototype.conv3dDerInput = function(t, e, n) {
		for (var r = dr(n.inShape, "float32"), o = r.values, a = r.strides, i = a[0], s = a[1], u = a[2], c = a[3], l = this.readSync(t.dataId), h = t.strides, f = h[0], d = h[1], p = h[2], v = h[3], m = this.readSync(e.dataId), g = e.strides, y = g[0], x = g[1], b = g[2], w = g[3], C = n.batchSize, E = n.filterDepth, R = n.filterHeight, I = n.filterWidth, k = n.inChannels, S = n.inDepth, A = n.inHeight, D = n.inWidth, T = n.outChannels, N = n.outDepth, F = n.outHeight, _ = n.outWidth, O = n.strideDepth, M = n.strideHeight, B = n.strideWidth, P = E - 1 - n.padInfo.front, L = R - 1 - n.padInfo.top, W = I - 1 - n.padInfo.left, U = 0; U < C; ++U) for (var V = 0; V < k; ++V) for (var z = 0; z < S; ++z) for (var G = z - P, H = Math.max(0, Math.ceil(G / O)), q = Math.min(N, (E + G) / O), K = 0; K < A; ++K) for (var j = K - L, X = Math.max(0, Math.ceil(j / M)), Y = Math.min(F, (R + j) / M), $ = 0; $ < D; ++$) {
			for (var Q = $ - W, J = Math.max(0, Math.ceil(Q / B)), Z = Math.min(_, (I + Q) / B), tt = 0, et = H; et < q; ++et) for (var nt = et * O - G, rt = X; rt < Y; ++rt) for (var ot = rt * M - j, at = J; at < Z; ++at) for (var it = f * U + d * et + p * rt + v * at, st = y * (E - 1 - nt) + x * (R - 1 - ot) + b * (I - 1 - (at * B - Q)) + w * V, ut = 0; ut < T; ++ut) tt += l[it + ut] * m[st + ut];
		...
		for (var r = dr(n.inShape, "float32"), o = r.values, a = r.strides, i = a[0], s = a[1], u = a[2], c = this.readSync(t.dataId), l = t.strides, h = l[0], f = l[1], d = l[2], p = this.readSync(e.dataId), v = e.strides, m = v[0], g = v[1], y = v[2], x = n.batchSize, b = n.filterHeight, w = n.filterWidth, C = n.inChannels, E = n.inHeight, R = n.inWidth, I = n.outChannels, k = n.outHeight, S = n.outWidth, A = n.strideHeight, D = n.strideWidth, T = b - 1 - n.padInfo.top, N = w - 1 - n.padInfo.left, F = I / C, _ = 0; _ < x; ++_) for (var O = 0; O < C; ++O) for (var M = 0; M < E; ++M) for (var B = M - T, P = Math.max(0, Math.ceil(B / A)), L = Math.min(k, (b + B) / A), W = 0; W < R; ++W) {
			for (var U = W - N, V = Math.max(0, Math.ceil(U / D)), z = Math.min(S, (w + U) / D), G = 0, H = P; H < L; ++H) for (var q = H * A - B, K = V; K < z; ++K) for (var j = h * _ + f * H + d * K, X = m * (b - 1 - q) + g * (w - 1 - (K * D - U)) + y * O, Y = 0; Y < F; ++Y) G += c[j + (O * F + Y)] * p[X + Y];
			o[i * _ + s * M + u * W + O] = G;
		}
		return r.toTensor();
	}, o.prototype.depthwiseConv2DDerFilter = function(t, e, n) {
		...
		for (var o = t.shape, a = o[0], i = o[1], s = o[2], u = o[3], c = this.readSync(t.dataId), l = new Float32Array(k([
			...
			n,
			u
		])), h = [r && e > 1 ? i - 1 : i, r && n > 1 ? s - 1 : s], f = [r && e > 1 ? e - 1 : e, r && n > 1 ? n - 1 : n], d = 0, p = h[0] / f[0], v = h[1] / f[1], m = 0; m < a; m++) for (var g = 0; g < e; g++) for (var y = p * g, x = Math.floor(y), b = y - x, w = Math.min(i - 1, Math.ceil(y)), C = m * t.strides[0] + x * t.strides[1], E = m * t.strides[0] + w * t.strides[1], R = 0; R < n; R++) for (var I = v * R, S = Math.floor(I), A = I - S, D = Math.min(s - 1, Math.ceil(I)), T = C + S * t.strides[2], N = E + S * t.strides[2], F = C + D * t.strides[2], _ = E + D * t.strides[2], O = 0; O < u; O++) {
		...
		}(e, n), l = Dn(c.real, c.imag).mul(u), h = i.add(l), f = i.sub(l);
		return Dn(Tn(h).concat(Tn(f)), Nn(h).concat(Nn(f))).as1D();
		...
		for (var i = t.shape, s = i[0], u = i[1], c = i[2], l = i[3], h = e.shape[0], f = r[0], d = r[1], p = dr([
			...
			if (!(k >= s)) for (var S = f > 1 ? (R - C) * (u - 1) / (f - 1) : 0, A = d > 1 ? (I - E) * (c - 1) / (d - 1) : 0, D = 0; D < f; D++) {
				...
				if (T < 0 || T > u - 1) for (var N = 0; N < d; N++) for (var F = 0; F < l; F++) {
					...
					for (N = 0; N < d; N++) if ((q = d > 1 ? E * (c - 1) + N * A : .5 * (E + I) * (c - 1)) < 0 || q > c - 1) for (F = 0; F < l; F++) {
...
for (var Jh = 0, Zh = [
	{
		...
		backendName: "webgl",
		kernelFunc: function(t) {
			var e = t.inputs, n = t.backend, r = t.attrs, o = e.pixels, a = r.numChannels, s = "undefined" != typeof HTMLVideoElement && o instanceof HTMLVideoElement, u = "undefined" != typeof HTMLImageElement && o instanceof HTMLImageElement, c = s ? [o.videoWidth, o.videoHeight] : [o.width, o.height], l = c[0], h = c[1], f = [h, l], d = [
				h,
				l,
				a
			];
			(u || s) && (Yh ??= document.createElement("canvas").getContext("2d"), Yh.canvas.width = l, Yh.canvas.height = h, Yh.drawImage(o, 0, 0, l, h), o = Yh.canvas);
			...
			var v = i().getBool("WEBGL_PACK") ? new Qh(d) : new $h(d), m = n.runWebGLProgram(v, [p], "int32");
...
var nf = function() {
	...
	return t.prototype.fetch = function(t, e) {
		...
		return this.textEncoder ??= new TextEncoder(), this.textEncoder.encode(t);
...
var rf, of = function() {
	return require_browser_external_node_fetch();
}, af = function() {
	function t() {
		this.util = require_browser_external_util(), this.textEncoder = new this.util.TextEncoder();
	}
	return t.prototype.fetch = function(t, e) {
		return null != i().global.fetch ? i().global.fetch(t, e) : (rf ??= of(), rf(t, e));
	}, t.prototype.now = function() {
	...
	return void 0 === o && (o = !1), n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				...
				case 1: return h = r.sent(), o && l ? [4, yf.getManager(u).removeModel(c)] : [3, 3];
				case 2: r.sent(), r.label = 3;
				case 3: return [4, s.save(h)];
				case 4: return f = r.sent(), !o || l ? [3, 6] : [4, yf.getManager(u).removeModel(c)];
				case 5: r.sent(), r.label = 6;
				case 6: return [2, f.modelArtifactsInfo];
			}
		}));
	}));
}
			...
			o.onupgradeneeded = function() {
				...
				if (null == e) {
					...
					s.onsuccess = function() {
						if (null == s.result) return a.close(), r(/* @__PURE__ */ new Error("Cannot find model with path '" + n.modelPath + "' in IndexedDB."));
				...
				return t = (r = t).startsWith(If.URL_SCHEME) ? r.slice(If.URL_SCHEME.length) : r, [2, new Promise((function(n, r) {
					...
					o.onupgradeneeded = function() {
						...
						u.onsuccess = function() {
							if (null == u.result) return a.close(), r(/* @__PURE__ */ new Error("Cannot find model with path '" + t + "' in IndexedDB."));
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				...
				try {
					...
					throw this.LS.removeItem(this.keys.info), this.LS.removeItem(this.keys.topology), this.LS.removeItem(this.keys.weightSpecs), this.LS.removeItem(this.keys.weightData), this.LS.removeItem(this.keys.modelMetadata), /* @__PURE__ */ new Error("Failed to save model '" + this.modelPath + "' to local storage: size quota being exceeded is a possible cause of this failure: modelTopologyBytes=" + o.modelTopologyBytes + ", weightSpecsBytes=" + o.weightSpecsBytes + ", weightDataBytes=" + o.weightDataBytes + ".");
				}
				return [2];
			}));
		}));
...
var Hf = function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					...
					case 1: return n = [{
						...
						convertedBy: t.convertedBy,
						weightsManifest: n
					}, a = window.URL.createObjectURL(new Blob([JSON.stringify(o)], { type: "application/json" })), (i = null == this.jsonAnchor ? document.createElement("a") : this.jsonAnchor).download = this.modelTopologyFileName, i.href = a, [4, Gf((function() {
						return i.dispatchEvent(new MouseEvent("click"));
					}))];
					case 2: return r.sent(), null == t.weightData ? [3, 4] : ((s = null == this.weightDataAnchor ? document.createElement("a") : this.weightDataAnchor).download = this.weightDataFileName, s.href = e, [4, Gf((function() {
						return s.dispatchEvent(new MouseEvent("click"));
					}))]);
					case 3: r.sent(), r.label = 4;
					case 4: return [2, { modelArtifactsInfo: vf(t) }];
				}
			}));
		}));
	...
	return t.prototype.load = function() {
				...
				return t = this.files[0], e = this.files.slice(1), [2, new Promise((function(r, o) {
					...
					a.onload = function(a) {
						...
						if (null != s) {
							...
							} else o(/* @__PURE__ */ new Error("weightManifest field is missing from file " + t.name));
						} else o(/* @__PURE__ */ new Error("modelTopology field is missing from file " + t.name));
					}, a.onerror = function(e) {
		...
		for (var n = [], r = e.map((function(t) {
			return pf(t.name);
		})), o = {}, a = 0, i = t; a < i.length; a++) i[a].paths.forEach((function(t) {
			var a = pf(t);
...
function jf(t, e) {
	return n(this, void 0, void 0, (function() {
		...
		return r(this, (function(r) {
			switch (r.label) {
				case 0: return e ??= {}, n = null == e.fetchFunc ? i().platform.fetch : e.fetchFunc, o = t.map((function(t) {
					return n(t, e.requestInit, { isBinary: !0 });
				})), a = 0, s = .5, null != e.onProgress ? [3, 2] : [4, Promise.all(o)];
				case 1: return u = r.sent(), [3, 4];
				case 2: return [4, Kf(o, e.onProgress, a, s)];
				case 3: u = r.sent(), r.label = 4;
				case 4: return c = u.map((function(t) {
					return t.arrayBuffer();
				})), l = .5, h = 1, null != e.onProgress ? [3, 6] : [4, Promise.all(c)];
				case 5: return f = r.sent(), [3, 8];
				case 6: return [4, Kf(c, e.onProgress, l, h)];
				case 7: f = r.sent(), r.label = 8;
				case 8: return [2, f];
			}
		}));
	}));
		...
		return void 0 === a && (a = ""), n(e, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					case 0:
						if (e = o.map((function() {
							...
							t.weights.forEach((function(t) {
								var c = sf["quantization" in t ? t.quantization.dtype : t.dtype] * k(t.shape), l = function() {
									e[r] = !0, n[r] ?? (n[r] = []), n[r].push({
										manifestEntry: t,
										groupOffset: o,
										sizeBytes: c
									});
							...
							return !s[e];
						})), /* @__PURE__ */ new Error("Could not find weights in manifest with names: " + c.join(", ") + ". \nManifest JSON has weights with names: " + u.join(", ") + ".");
					...
					case 1: return f = r.sent(), d = {}, p = 0, l.forEach((function(t) {
...
var Yf = function() {
	function t(t, e) {
		if (this.DEFAULT_METHOD = "POST", e ??= {}, this.weightPathPrefix = e.weightPathPrefix, this.onProgress = e.onProgress, null != e.fetchFunc ? (C("function" == typeof e.fetchFunc, (function() {
				...
				switch (r.label) {
					case 0:
						...
						return (e = Object.assign({ method: this.DEFAULT_METHOD }, this.requestInit)).body = new FormData(), n = [{
							...
							userDefinedMetadata: t.userDefinedMetadata,
							weightsManifest: n
						}, e.body.append("model.json", new Blob([JSON.stringify(o)], { type: "application/json" }), "model.json"), null != t.weightData && e.body.append("model.weights.bin", new Blob([t.weightData], { type: "application/octet-stream" }), "model.weights.bin"), [4, this.fetch(this.path, e)];
					case 1:
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					...
					case 6: f = r.sent(), l = f[0], h = f[1], r.label = 7;
					case 7: return [2, {
						modelTopology: o,
						weightSpecs: l,
						weightData: h,
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					...
					case 1: return f = r.sent(), [2, [s, df(f)]];
				}
			}));
		}));
...
var ed = Object.freeze({
	...
	fromMemory: function(t, e, n, r) {
		return 1 === arguments.length ? null != t.modelTopology || null != t.weightSpecs ? new Zf(t) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Zf({ modelTopology: t })) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Zf({
			modelTopology: t,
			weightSpecs: e,
			weightData: n,
			trainingConfig: r
	...
	listModels: function() {
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					case 0: t = yf.getSchemes(), e = {}, n = 0, o = t, r.label = 1;
					case 1: return n < o.length ? (a = o[n], [4, yf.getManager(a).listModels()]) : [3, 4];
					case 2:
...
var nd, rd = An({ confusionMatrix_: function(t, e, n) {
...
var ad = An({ fromPixels_: function(t, e) {
	...
	var s, u, c = o ? [t.videoWidth, t.videoHeight] : [t.width, t.height], h = c[0], f = c[1];
	if (i ? s = t.getContext("2d").getImageData(0, 0, h, f).data : r || n ? s = t.data : (a || o) && (nd ??= document.createElement("canvas").getContext("2d"), nd.canvas.width = h, nd.canvas.height = f, nd.drawImage(t, 0, 0, h, f), s = nd.getImageData(0, 0, h, f).data), 4 === e) u = new Int32Array(s);
	else {
		var d = h * f;
			...
			return r(this, (function(r) {
				switch (r.label) {
					case 0:
						...
						return [4, n.data()];
					case 1: return u = r.sent(), c = n.min(), l = n.max(), [4, Promise.all([c.data(), l.data()])];
					case 2:
...
var md = Object.freeze({
	...
	expectArraysClose: function(t, e, n) {
		return n ??= dd(), pd(t, e, (function(t, e) {
			return vd(t, e, n);
		}));
	},
	testEpsilon: dd,
	...
	expectNumbersClose: function(t, e, n) {
		if (n ??= dd(), !vd(t, e, n)) throw new Error("Numbers differ: actual === " + t + ", expected === " + e);
	},
...
var yd = Object.freeze({
	...
	return e(o, t), o.prototype.minimize = function(t, e, n) {
		...
		get: function() {
			return this.iterations_ ??= 0, this.iterations_;
		},
		enumerable: !0,
		configurable: !0
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(n) {
				switch (n.label) {
					case 0: return e = this, [4, t[0].tensor.data()];
					case 1: return e.iterations_ = n.sent()[0], [2, t.slice(1)];
				}
			}));
		}));
	}, o;
}(sd);
Object.defineProperty(xd, Symbol.hasInstance, { value: function(t) {
...
var bd = function(t) {
	function o(e, n, r) {
		...
		return o.learningRate = e, o.rho = n, o.epsilon = r, o.accumulatedGrads = [], o.accumulatedUpdates = [], r ?? (o.epsilon = Lt.backend.epsilon()), o;
	}
	return e(o, t), o.prototype.applyGradients = function(t) {
		...
		(Array.isArray(t) ? t.map((function(t) {
			...
			e.accumulatedGrads[r] ?? (e.accumulatedGrads[r] = {
				originalName: n + "/accum_grad",
				variable: Ze((function() {
					return Xn(o).variable(!1);
				}))
			}), e.accumulatedUpdates[r] ?? (e.accumulatedUpdates[r] = {
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(e) {
				switch (e.label) {
					...
					case 1: return [2, [e.sent()].concat(t.map((function(t) {
						return {
							name: t.originalName,
							tensor: t.variable
						};
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(n) {
				switch (n.label) {
					case 0: return [4, this.extractIterations(t)];
					case 1: return t = n.sent(), e = t.length / 2, this.accumulatedGrads = t.slice(0, e).map((function(t) {
						return {
							originalName: t.name,
...
var wd = function(t) {
	...
	return e(o, t), o.prototype.applyGradients = function(t) {
		...
		(Array.isArray(t) ? t.map((function(t) {
			...
			var o = Lt.registeredVariables[n];
			if (null == e.accumulatedGrads[r]) e.accumulatedGrads[r] = {
		...
		return n(this, void 0, void 0, (function() {
			return r(this, (function(t) {
				switch (t.label) {
					...
					case 1: return [2, [t.sent()].concat(this.accumulatedGrads.map((function(t) {
						return {
							name: t.originalName,
							tensor: t.variable
						};
		...
		return n(this, void 0, void 0, (function() {
			return r(this, (function(e) {
				switch (e.label) {
					case 0: return [4, this.extractIterations(t)];
					case 1: return t = e.sent(), this.accumulatedGrads = t.map((function(t) {
						return {
							originalName: t.name,
							variable: t.tensor.variable(!1)
						};
...
var Cd = function(t) {
	function o(e, n, r, o) {
		...
		})), o ?? (a.epsilon = Lt.backend.epsilon()), a;
	}
	return e(o, t), o.prototype.applyGradients = function(t) {
		...
		Ze((function() {
			...
			n.forEach((function(n, a) {
				...
				e.accumulatedFirstMoment[a] ?? (e.accumulatedFirstMoment[a] = {
					originalName: n + "/m",
					variable: Ze((function() {
						return Xn(i).variable(!1);
					}))
				}), e.accumulatedSecondMoment[a] ?? (e.accumulatedSecondMoment[a] = {
					originalName: n + "/v",
					variable: Ze((function() {
						return Xn(i).variable(!1);
					}))
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(r) {
				switch (r.label) {
					case 0: return [4, this.extractIterations(t)];
					case 1: return t = r.sent(), Ze((function() {
...
var Ed = function(t) {
	function o(e, n, r, o, a) {
		...
		})), o ?? (i.epsilon = Lt.backend.epsilon()), i;
	}
	return e(o, t), o.prototype.applyGradients = function(t) {
		var e = this, n = Array.isArray(t) ? t.map((function(t) {
			return t.name;
		...
		Ze((function() {
			...
			n.forEach((function(n, a) {
				...
				}), e.accumulatedWeightedInfNorm[a] ?? (e.accumulatedWeightedInfNorm[a] = {
					originalName: n + "/v",
					variable: Xn(i).variable(!1)
				});
				var s = Array.isArray(t) ? t[a].tensor : t[n];
...
var Id = function(t) {
	...
	return e(o, t), o.prototype.applyGradients = function(t) {
		...
		(Array.isArray(t) ? t.map((function(t) {
			...
			var o = Lt.registeredVariables[n];
			if (null == e.accumulations[r]) e.accumulations[r] = {
		...
		return n(this, void 0, void 0, (function() {
			return r(this, (function(t) {
				switch (t.label) {
					case 0: return [4, this.saveIterations()];
					case 1: return [2, [t.sent()].concat(this.accumulations.map((function(t) {
						return {
							name: t.originalName,
							tensor: t.variable
						};
		...
		return n(this, void 0, void 0, (function() {
			return r(this, (function(e) {
				switch (e.label) {
					case 0: return [4, this.extractIterations(t)];
					case 1: return t = e.sent(), this.accumulations = t.map((function(t) {
						return {
							originalName: t.name,
							variable: t.tensor.variable(!1)
						};
...
var kd = function(t) {
	function o(e, n, r, o, a) {
		...
		var i = t.call(this) || this;
		if (i.learningRate = e, i.decay = n, i.momentum = r, i.epsilon = o, i.accumulatedMeanSquares = [], i.accumulatedMoments = [], i.accumulatedMeanGrads = [], i.centered = a, o ?? (i.epsilon = Lt.backend.epsilon()), null == e) throw new Error("learningRate for RMSPropOptimizer must be defined.");
		return i;
	}
	return e(o, t), o.prototype.applyGradients = function(t) {
		var e = this;
		(Array.isArray(t) ? t.map((function(t) {
			...
			var o = Lt.registeredVariables[n];
			e.accumulatedMeanSquares[r] ?? (e.accumulatedMeanSquares[r] = {
				originalName: n + "/rms",
				variable: Ze((function() {
					return Xn(o).variable(!1);
				}))
			}), e.accumulatedMoments[r] ?? (e.accumulatedMoments[r] = {
				originalName: n + "/momentum",
				variable: Ze((function() {
					return Xn(o).variable(!1);
				}))
		...
		return n(this, void 0, void 0, (function() {
			...
			return r(this, (function(n) {
				switch (n.label) {
					case 0: return [4, this.extractIterations(t)];
					case 1: return t = n.sent(), e = this.centered ? t.length / 3 : t.length / 2, this.accumulatedMeanSquares = t.slice(0, e).map((function(t) {
						return {
							originalName: t.name,
							variable: t.tensor.variable(!1)
						};
...
//#endregion
//#region node_modules/face-api.js/build/es6/draw/drawContour.js
...
//#endregion
//#region node_modules/face-api.js/node_modules/tslib/tslib.es6.js
/*! *****************************************************************************
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/Dimensions.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/utils/index.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/Point.js
var Point = function() {
	function Point(x, y) {
		this._x = x;
		this._y = y;
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/Box.js
var Box = function() {
	...
	Box.assertIsValidBox = function(box, callee, allowNegativeDimensions) {
		...
		if (!Box.isRect(box)) throw new Error(callee + " - invalid box: " + JSON.stringify(box) + ", expected object with properties x, y, width, height");
	...
	Box.prototype.clipAtImageBorders = function(imgWidth, imgHeight) {
		...
		return new Box({
			x: clippedX,
			y: clippedY,
			width: Math.min(newWidth, imgWidth - clippedX),
			height: Math.min(newHeight, imgHeight - clippedY)
		}).floor();
	};
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/BoundingBox.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/ObjectDetection.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/FaceDetection.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ops/iou.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ops/minBbox.js
function minBbox(pts) {
	...
	return new BoundingBox(xs.reduce(function(min, x) {
		return x < min ? x : min;
	}, Infinity), ys.reduce(function(min, y) {
		return y < min ? y : min;
	}, Infinity), xs.reduce(function(max, x) {
		return max < x ? x : max;
	}, 0), ys.reduce(function(max, y) {
		return max < y ? y : max;
	}, 0));
}
//#endregion
//#region node_modules/face-api.js/build/es6/ops/nonMaxSuppression.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ops/normalize.js
function normalize(x, meanRgb) {
	return Ze(function() {
		var r = meanRgb[0], g = meanRgb[1], b = meanRgb[2];
		return Cc(x, Yn([
			Hn(__spreadArrays(x.shape.slice(0, 3), [1]), r),
			Hn(__spreadArrays(x.shape.slice(0, 3), [1]), g),
			Hn(__spreadArrays(x.shape.slice(0, 3), [1]), b)
		], 3));
	});
}
//#endregion
//#region node_modules/face-api.js/build/es6/ops/padToSquare.js
/**
...
function padToSquare(imgTensor, isCenterImage) {
	...
	return Ze(function() {
		...
		var paddingAmount = Math.round(dimDiff * (isCenterImage ? .5 : 1));
...
//#endregion
//#region node_modules/face-api.js/build/es6/ops/shuffleArray.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ops/index.js
function sigmoid(x) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/Rect.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/FaceLandmarks.js
var relX = .5;
var relY = .43;
var relScale = .45;
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/FaceLandmarks5.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/FaceLandmarks68.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/FaceMatch.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/LabeledBox.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/LabeledFaceDescriptors.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/classes/PredictedBox.js
var PredictedBox = function(_super) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/factories/WithFaceDetection.js
function isWithFaceDetection(obj) {
	return obj["detection"] instanceof FaceDetection;
}
function extendWithFaceDetection(sourceObj, detection) {
	return Object.assign({}, sourceObj, { detection });
}
//#endregion
//#region node_modules/face-api.js/build/es6/env/createBrowserEnv.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/env/createFileSystem.js
function createFileSystem(fs) {
	...
	return { readFile: fs ? function(filePath) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/env/createNodejsEnv.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/env/isBrowser.js
function isBrowser() {
...
initialize();
//#endregion
//#region node_modules/face-api.js/build/es6/dom/resolveInput.js
function resolveInput(arg) {
	if (!env.isNodejs() && typeof arg === "string") return document.getElementById(arg);
	return arg;
}
//#endregion
//#region node_modules/face-api.js/build/es6/dom/getContext2dOrThrow.js
function getContext2dOrThrow(canvasArg) {
	var _a = env.getEnv(), Canvas = _a.Canvas;
	if (canvasArg instanceof _a.CanvasRenderingContext2D) return canvasArg;
...
//#endregion
//#region node_modules/face-api.js/build/es6/draw/DrawTextField.js
var AnchorPosition;
...
var DrawTextField = function() {
	...
	DrawTextField.prototype.getUpperLeft = function(ctx, canvasDims) {
		...
		if (canvasDims) {
			...
			return {
				x: Math.max(Math.min(x, width - textFieldWidth), 0),
				y: Math.max(Math.min(y, height - textFieldHeight), 0)
			};
		}
		return {
			x,
...
//#endregion
//#region node_modules/face-api.js/build/es6/draw/DrawBox.js
...
var DrawBox = function() {
	...
	DrawBox.prototype.draw = function(canvasArg) {
		...
		if (label) new DrawTextField([label], {
			x: x - lineWidth / 2,
			y
...
//#endregion
//#region node_modules/face-api.js/build/es6/draw/drawDetections.js
function drawDetections(canvasArg, detections) {
	(Array.isArray(detections) ? detections : [detections]).forEach(function(det) {
		var score = det instanceof FaceDetection ? det.score : isWithFaceDetection(det) ? det.detection.score : void 0;
		new DrawBox(det instanceof FaceDetection ? det.box : isWithFaceDetection(det) ? det.detection.box : new Box(det), { label: score ? "" + round(score) : void 0 }).draw(canvasArg);
	});
}
//#endregion
//#region node_modules/face-api.js/build/es6/dom/isMediaLoaded.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/awaitMediaLoaded.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/bufferToImage.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/getMediaDimensions.js
function getMediaDimensions(input) {
	var _a = env.getEnv(), Image = _a.Image, Video = _a.Video;
	if (input instanceof Image) return new Dimensions(input.naturalWidth, input.naturalHeight);
	if (input instanceof Video) return new Dimensions(input.videoWidth, input.videoHeight);
	return new Dimensions(input.width, input.height);
}
//#endregion
//#region node_modules/face-api.js/build/es6/dom/createCanvas.js
...
function createCanvasFromMedia(media, dims) {
	...
	if (!(media instanceof ImageData) && !isMediaLoaded(media)) throw new Error("createCanvasFromMedia - media has not finished loading yet");
	var _a = dims || getMediaDimensions(media), width = _a.width, height = _a.height;
	var canvas = createCanvas({
		width,
		height
	});
	if (media instanceof ImageData) getContext2dOrThrow(canvas).putImageData(media, 0, 0);
	else getContext2dOrThrow(canvas).drawImage(media, 0, 0, width, height);
	return canvas;
}
//#endregion
//#region node_modules/face-api.js/build/es6/dom/imageTensorToCanvas.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/isMediaElement.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/imageToSquare.js
function imageToSquare(input, inputSize, centerImage) {
	...
	if (!(input instanceof Image || input instanceof Canvas)) throw new Error("imageToSquare - expected arg0 to be HTMLImageElement | HTMLCanvasElement");
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/NetInput.js
var NetInput = function() {
	...
	NetInput.prototype.getReshapedInputDimensions = function(batchIdx) {
		...
		return computeReshapedDimensions({
			width: this.getInputWidth(batchIdx),
			height: this.getInputHeight(batchIdx)
		}, this.inputSize);
	};
	/**
	...
	*/
	NetInput.prototype.toBatchTensor = function(inputSize, isCenterInputs) {
		...
		return Ze(function() {
			return Pr(range(_this.batchSize, 0, 1).map(function(batchIdx) {
				var input = _this.getInput(batchIdx);
				if (input instanceof wt) {
					var imgTensor = isTensor4D(input) ? input : input.expandDims();
					imgTensor = padToSquare(imgTensor, isCenterInputs);
					if (imgTensor.shape[1] !== inputSize || imgTensor.shape[2] !== inputSize) imgTensor = Oh.resizeBilinear(imgTensor, [inputSize, inputSize]);
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/toNetInput.js
/**
...
function toNetInput(inputs) {
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(_a) {
			switch (_a.label) {
				case 0:
					if (inputs instanceof NetInput) return [2, inputs];
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/extractFaces.js
/**
		...
		return __generator(this, function(_b) {
			switch (_b.label) {
				...
				case 1:
					...
					_a = tensorOrCanvas;
					return [3, 4];
				case 2: return [4, imageTensorToCanvas(tensorOrCanvas)];
				case 3:
					_a = _b.sent();
					_b.label = 4;
				case 4:
				...
				case 5:
					...
					return [2, boxes.map(function(_a) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/extractFaceTensors.js
/**
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/fetchOrThrow.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/fetchImage.js
function fetchImage(uri) {
	return __awaiter(this, void 0, void 0, function() {
		var res, blob;
		return __generator(this, function(_a) {
			switch (_a.label) {
				case 0: return [4, fetchOrThrow(uri)];
				case 1:
					res = _a.sent();
					return [4, res.blob()];
				case 2:
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/fetchJson.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/fetchNetWeights.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/getModelUris.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/loadWeightMap.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/dom/matchDimensions.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/NeuralNetwork.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/depthwiseSeparableConv.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/denseBlock.js
function denseBlock3(x, denseBlockParams, isFirstLayer) {
	if (isFirstLayer === void 0) isFirstLayer = false;
	return Ze(function() {
		var out1 = Bl(isFirstLayer ? rc(qc(x, denseBlockParams.conv0.filters, [2, 2], "same"), denseBlockParams.conv0.bias) : depthwiseSeparableConv$1(x, denseBlockParams.conv0, [2, 2]));
		var out2 = depthwiseSeparableConv$1(out1, denseBlockParams.conv1, [1, 1]);
		return Bl(rc(out1, rc(out2, depthwiseSeparableConv$1(Bl(rc(out1, out2)), denseBlockParams.conv2, [1, 1]))));
	});
}
function denseBlock4(x, denseBlockParams, isFirstLayer, isScaleDown) {
	...
	return Ze(function() {
		var out1 = Bl(isFirstLayer ? rc(qc(x, denseBlockParams.conv0.filters, isScaleDown ? [2, 2] : [1, 1], "same"), denseBlockParams.conv0.bias) : depthwiseSeparableConv$1(x, denseBlockParams.conv0, isScaleDown ? [2, 2] : [1, 1]));
		var out2 = depthwiseSeparableConv$1(out1, denseBlockParams.conv1, [1, 1]);
		var out3 = depthwiseSeparableConv$1(Bl(rc(out1, out2)), denseBlockParams.conv2, [1, 1]);
		return Bl(rc(out1, rc(out2, rc(out3, depthwiseSeparableConv$1(Bl(rc(out1, rc(out2, out3))), denseBlockParams.conv3, [1, 1])))));
	});
}
//#endregion
//#region node_modules/face-api.js/build/es6/common/convLayer.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/disposeUnusedWeightTensors.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/extractConvParamsFactory.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/extractFCParamsFactory.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/types.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/extractSeparableConvParamsFactory.js
...
function loadSeparableConvParamsFactory(extractWeightEntry) {
	return function(prefix) {
		return new SeparableConvParams(extractWeightEntry(prefix + "/depthwise_filter", 4), extractWeightEntry(prefix + "/pointwise_filter", 4), extractWeightEntry(prefix + "/bias", 1));
	};
}
//#endregion
//#region node_modules/face-api.js/build/es6/common/extractWeightEntryFactory.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/extractWeightsFactory.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/extractorsFactory.js
function extractorsFactory$9(extractWeights, paramMappings) {
	...
	function extractDenseBlock3Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer) {
		if (isFirstLayer === void 0) isFirstLayer = false;
		return {
			conv0: isFirstLayer ? extractConvParams(channelsIn, channelsOut, 3, mappedPrefix + "/conv0") : extractSeparableConvParams(channelsIn, channelsOut, mappedPrefix + "/conv0"),
			conv1: extractSeparableConvParams(channelsOut, channelsOut, mappedPrefix + "/conv1"),
			conv2: extractSeparableConvParams(channelsOut, channelsOut, mappedPrefix + "/conv2")
		};
	}
	function extractDenseBlock4Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer) {
		...
		return {
			...
			conv1: _a.conv1,
			conv2: _a.conv2,
			conv3: extractSeparableConvParams(channelsOut, channelsOut, mappedPrefix + "/conv3")
		};
	}
	return {
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/extractParams.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/loadConvParamsFactory.js
function loadConvParamsFactory(extractWeightEntry) {
	return function(prefix) {
		return {
			filters: extractWeightEntry(prefix + "/filters", 4),
			bias: extractWeightEntry(prefix + "/bias", 1)
		};
	};
}
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/loadParamsFactory.js
function loadParamsFactory$1(weightMap, paramMappings) {
	...
	function extractDenseBlock3Params(prefix, isFirstLayer) {
		if (isFirstLayer === void 0) isFirstLayer = false;
		return {
			conv0: isFirstLayer ? extractConvParams(prefix + "/conv0") : extractSeparableConvParams(prefix + "/conv0"),
			conv1: extractSeparableConvParams(prefix + "/conv1"),
			conv2: extractSeparableConvParams(prefix + "/conv2")
		};
	}
	function extractDenseBlock4Params(prefix, isFirstLayer) {
		...
		return {
			...
			conv1: extractSeparableConvParams(prefix + "/conv1"),
			conv2: extractSeparableConvParams(prefix + "/conv2"),
			conv3: extractSeparableConvParams(prefix + "/conv3")
		};
	}
	return {
		extractDenseBlock3Params,
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/extractParamsFromWeigthMap.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/FaceFeatureExtractor.js
var FaceFeatureExtractor = function(_super) {
	...
	FaceFeatureExtractor.prototype.forwardInput = function(input) {
		...
		return Ze(function() {
			var out = denseBlock4(normalize(input.toBatchTensor(112, true), [
				122.782,
				117.001,
				104.298
			]).div(On(255)), params.dense0, true);
...
//#endregion
//#region node_modules/face-api.js/build/es6/common/fullyConnectedLayer.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceProcessor/extractParams.js
function extractParams$6(weights, channelsIn, channelsOut) {
	var paramMappings = [];
	var _a = extractWeightsFactory(weights), extractWeights = _a.extractWeights, getRemainingWeights = _a.getRemainingWeights;
	var fc = extractFCParamsFactory(extractWeights, paramMappings)(channelsIn, channelsOut, "fc");
	if (getRemainingWeights().length !== 0) throw new Error("weights remaing after extract: " + getRemainingWeights().length);
	return {
		paramMappings,
		params: { fc }
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceProcessor/extractParamsFromWeigthMap.js
function extractParamsFromWeigthMap$6(weightMap) {
	var paramMappings = [];
	var extractWeightEntry = extractWeightEntryFactory(weightMap, paramMappings);
	function extractFcParams(prefix) {
		return {
			weights: extractWeightEntry(prefix + "/weights", 2),
			bias: extractWeightEntry(prefix + "/bias", 1)
		};
	}
	var params = { fc: extractFcParams("fc") };
	disposeUnusedWeightTensors(weightMap, paramMappings);
	return {
		params,
		paramMappings
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceProcessor/util.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceProcessor/FaceProcessor.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceExpressionNet/FaceExpressions.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceExpressionNet/FaceExpressionNet.js
var FaceExpressionNet = function(_super) {
	...
	FaceExpressionNet.prototype.predictExpressions = function(input) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0: return [4, toNetInput(input)];
					case 1:
						netInput = _a.sent();
						return [4, this.forwardInput(netInput)];
					case 2:
						out = _a.sent();
						return [4, Promise.all(Ur(out).map(function(t) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/factories/WithFaceExpressions.js
function isWithFaceExpressions(obj) {
	return obj["expressions"] instanceof FaceExpressions;
}
function extendWithFaceExpressions(sourceObj, expressions) {
	return Object.assign({}, sourceObj, { expressions });
}
//#endregion
//#region node_modules/face-api.js/build/es6/draw/drawFaceExpressions.js
function drawFaceExpressions(canvasArg, faceExpressions, minConfidence, textFieldAnchor) {
	if (minConfidence === void 0) minConfidence = .1;
	(Array.isArray(faceExpressions) ? faceExpressions : [faceExpressions]).forEach(function(e) {
		...
		var resultsToDisplay = expr.asSortedArray().filter(function(expr) {
		...
		new DrawTextField(resultsToDisplay.map(function(expr) {
			return expr.expression + " (" + round(expr.probability) + ")";
		}), anchor).draw(canvasArg);
	});
}
//#endregion
//#region node_modules/face-api.js/build/es6/factories/WithFaceLandmarks.js
...
function extendWithFaceLandmarks(sourceObj, unshiftedLandmarks) {
	...
	var extension = {
		landmarks,
		unshiftedLandmarks,
		alignedRect: new FaceDetection(sourceObj.detection.score, rect.rescale(imageDims.reverse()), imageDims)
	};
	return Object.assign({}, sourceObj, extension);
}
//#endregion
//#region node_modules/face-api.js/build/es6/draw/DrawFaceLandmarks.js
...
function drawFaceLandmarks(canvasArg, faceLandmarks) {
	(Array.isArray(faceLandmarks) ? faceLandmarks : [faceLandmarks]).forEach(function(f) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/draw/index.js
var draw_exports = /* @__PURE__ */ __exportAll({
	AnchorPosition: () => AnchorPosition,
	DrawBox: () => DrawBox,
...
//#endregion
//#region node_modules/face-api.js/build/es6/xception/extractParams.js
function extractorsFactory$8(extractWeights, paramMappings) {
	var extractConvParams = extractConvParamsFactory(extractWeights, paramMappings);
	var extractSeparableConvParams = extractSeparableConvParamsFactory(extractWeights, paramMappings);
	function extractReductionBlockParams(channelsIn, channelsOut, mappedPrefix) {
		return {
			separable_conv0: extractSeparableConvParams(channelsIn, channelsOut, mappedPrefix + "/separable_conv0"),
			separable_conv1: extractSeparableConvParams(channelsOut, channelsOut, mappedPrefix + "/separable_conv1"),
			expansion_conv: extractConvParams(channelsIn, channelsOut, 1, mappedPrefix + "/expansion_conv")
		};
	}
	function extractMainBlockParams(channels, mappedPrefix) {
		return {
			separable_conv0: extractSeparableConvParams(channels, channels, mappedPrefix + "/separable_conv0"),
			separable_conv1: extractSeparableConvParams(channels, channels, mappedPrefix + "/separable_conv1"),
			separable_conv2: extractSeparableConvParams(channels, channels, mappedPrefix + "/separable_conv2")
		};
	}
	return {
		extractConvParams,
...
function extractParams$5(weights, numMainBlocks) {
	...
	var entry_flow = {
		conv_in: extractConvParams(3, 32, 3, "entry_flow/conv_in"),
		reduction_block_0: extractReductionBlockParams(32, 64, "entry_flow/reduction_block_0"),
		reduction_block_1: extractReductionBlockParams(64, 128, "entry_flow/reduction_block_1")
	};
	var middle_flow = {};
	...
	var exit_flow = {
		reduction_block: extractReductionBlockParams(128, 256, "exit_flow/reduction_block"),
		separable_conv: extractSeparableConvParams(256, 512, "exit_flow/separable_conv")
	};
	if (getRemainingWeights().length !== 0) throw new Error("weights remaing after extract: " + getRemainingWeights().length);
	return {
		paramMappings,
...
//#endregion
//#region node_modules/face-api.js/build/es6/xception/extractParamsFromWeigthMap.js
function loadParamsFactory(weightMap, paramMappings) {
	...
	function extractReductionBlockParams(mappedPrefix) {
		return {
			separable_conv0: extractSeparableConvParams(mappedPrefix + "/separable_conv0"),
			separable_conv1: extractSeparableConvParams(mappedPrefix + "/separable_conv1"),
			expansion_conv: extractConvParams(mappedPrefix + "/expansion_conv")
		};
	}
	function extractMainBlockParams(mappedPrefix) {
		return {
			separable_conv0: extractSeparableConvParams(mappedPrefix + "/separable_conv0"),
			separable_conv1: extractSeparableConvParams(mappedPrefix + "/separable_conv1"),
			separable_conv2: extractSeparableConvParams(mappedPrefix + "/separable_conv2")
		};
	}
	return {
		extractConvParams,
...
function extractParamsFromWeigthMap$5(weightMap, numMainBlocks) {
	...
	var entry_flow = {
		conv_in: extractConvParams("entry_flow/conv_in"),
		reduction_block_0: extractReductionBlockParams("entry_flow/reduction_block_0"),
		reduction_block_1: extractReductionBlockParams("entry_flow/reduction_block_1")
	};
	var middle_flow = {};
	range(numMainBlocks, 0, 1).forEach(function(idx) {
	...
	var exit_flow = {
		reduction_block: extractReductionBlockParams("exit_flow/reduction_block"),
		separable_conv: extractSeparableConvParams("exit_flow/separable_conv")
	};
	disposeUnusedWeightTensors(weightMap, paramMappings);
	return {
		params: {
...
//#endregion
//#region node_modules/face-api.js/build/es6/xception/TinyXception.js
...
var TinyXception = function(_super) {
	...
	TinyXception.prototype.forwardInput = function(input) {
		...
		return Ze(function() {
			var out = Bl(conv$1(normalize(input.toBatchTensor(112, true), [
				122.782,
				117.001,
				104.298
			]).div(On(256)), params.entry_flow.conv_in, [2, 2]));
...
//#endregion
//#region node_modules/face-api.js/build/es6/ageGenderNet/extractParams.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ageGenderNet/extractParamsFromWeigthMap.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ageGenderNet/types.js
var Gender;
(function(Gender) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/ageGenderNet/AgeGenderNet.js
var AgeGenderNet = function(_super) {
	...
	AgeGenderNet.prototype.runNet = function(input) {
		...
		return Ze(function() {
			...
			return {
				age: fullyConnectedLayer(pooled, params.fc.age).as1D(),
				gender: fullyConnectedLayer(pooled, params.fc.gender)
			};
		});
	};
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceLandmarkNet/FaceLandmark68NetBase.js
	...
	FaceLandmark68NetBase.prototype.postProcess = function(output, inputSize, originalDimensions) {
		...
		return Ze(function() {
			var createInterleavedTensor = function(fillX, fillY) {
				return Pr([Hn([68], fillX), Hn([68], fillY)], 1).as2D(1, 136).as1D();
			};
			...
			return output.mul(Hn([batchSize, 136], inputSize)).sub(Pr(Array.from(Array(batchSize), function(_, batchIdx) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceLandmarkNet/FaceLandmark68Net.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/extractParamsFromWeigthMapTiny.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/extractParamsTiny.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceFeatureExtractor/TinyFaceFeatureExtractor.js
var TinyFaceFeatureExtractor = function(_super) {
	...
	TinyFaceFeatureExtractor.prototype.forwardInput = function(input) {
		...
		return Ze(function() {
			var out = denseBlock3(normalize(input.toBatchTensor(112, true), [
				122.782,
				117.001,
				104.298
			]).div(On(255)), params.dense0, true);
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceLandmarkNet/FaceLandmark68TinyNet.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceLandmarkNet/index.js
var FaceLandmarkNet = function(_super) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceRecognitionNet/scaleLayer.js
function scale(x, params) {
	return rc(gc(x, params.weights), params.biases);
}
//#endregion
//#region node_modules/face-api.js/build/es6/faceRecognitionNet/convLayer.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceRecognitionNet/extractParams.js
function extractorsFactory$7(extractWeights, paramMappings) {
	...
	function extractConvLayerParams(numFilterValues, numFilters, filterSize, mappedPrefix) {
		return {
			conv: extractConvParams(numFilterValues, numFilters, filterSize, mappedPrefix + "/conv"),
			scale: extractScaleLayerParams(numFilters, mappedPrefix + "/scale")
		};
	}
	function extractResidualLayerParams(numFilterValues, numFilters, filterSize, mappedPrefix, isDown) {
		...
		return {
			conv1: extractConvLayerParams((isDown ? .5 : 1) * numFilterValues, numFilters, filterSize, mappedPrefix + "/conv1"),
			conv2: extractConvLayerParams(numFilterValues, numFilters, filterSize, mappedPrefix + "/conv2")
		};
	}
	return {
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceRecognitionNet/extractParamsFromWeigthMap.js
function extractorsFactory$6(weightMap, paramMappings) {
	var extractWeightEntry = extractWeightEntryFactory(weightMap, paramMappings);
	function extractScaleLayerParams(prefix) {
		return {
			weights: extractWeightEntry(prefix + "/scale/weights", 1),
			biases: extractWeightEntry(prefix + "/scale/biases", 1)
		};
	}
...
function extractParamsFromWeigthMap$3(weightMap) {
	...
	if (!isTensor2D(fc)) throw new Error("expected weightMap[fc] to be a Tensor2D, instead have " + fc);
	var params = {
		conv32_down,
		conv32_1,
		conv32_2,
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceRecognitionNet/residualLayer.js
...
function residualDown(x, params) {
	...
	if (pooled.shape[1] !== out.shape[1] || pooled.shape[2] !== out.shape[2]) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceRecognitionNet/FaceRecognitionNet.js
var FaceRecognitionNet = function(_super) {
	...
	FaceRecognitionNet.prototype.forwardInput = function(input) {
		...
		return Ze(function() {
			var out = convDown(normalize(input.toBatchTensor(150, true).toFloat(), [
				122.782,
				117.001,
				104.298
			]).div(On(256)), params.conv32_down);
			...
			return el(out.mean([1, 2]), params.fc);
		});
	};
...
//#endregion
//#region node_modules/face-api.js/build/es6/faceRecognitionNet/index.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/factories/WithFaceDescriptor.js
function extendWithFaceDescriptor(sourceObj, descriptor) {
	return Object.assign({}, sourceObj, { descriptor });
}
//#endregion
//#region node_modules/face-api.js/build/es6/factories/WithAge.js
function isWithAge(obj) {
	return typeof obj["age"] === "number";
}
function extendWithAge(sourceObj, age) {
	return Object.assign({}, sourceObj, { age });
}
//#endregion
//#region node_modules/face-api.js/build/es6/factories/WithGender.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/MtcnnOptions.js
var MtcnnOptions = function() {
	function MtcnnOptions(_a) {
		...
		this._scaleFactor = scaleFactor || .709;
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/extractParams.js
function extractorsFactory$5(extractWeights, paramMappings) {
	...
	function extractPointwiseConvParams(channelsIn, channelsOut, filterSize, mappedPrefix) {
		...
		return {
			filters: _a.filters,
			batch_norm_offset: _a.bias
		};
	}
	function extractConvPairParams(channelsIn, channelsOut, mappedPrefix) {
		return {
			depthwise_conv: extractDepthwiseConvParams(channelsIn, mappedPrefix + "/depthwise_conv"),
			pointwise_conv: extractPointwiseConvParams(channelsIn, channelsOut, 1, mappedPrefix + "/pointwise_conv")
		};
	}
	function extractMobilenetV1Params() {
		return {
			conv_0: extractPointwiseConvParams(3, 32, 3, "mobilenetv1/conv_0"),
			conv_1: extractConvPairParams(32, 64, "mobilenetv1/conv_1"),
			conv_2: extractConvPairParams(64, 128, "mobilenetv1/conv_2"),
			conv_3: extractConvPairParams(128, 128, "mobilenetv1/conv_3"),
			conv_4: extractConvPairParams(128, 256, "mobilenetv1/conv_4"),
			conv_5: extractConvPairParams(256, 256, "mobilenetv1/conv_5"),
			conv_6: extractConvPairParams(256, 512, "mobilenetv1/conv_6"),
			conv_7: extractConvPairParams(512, 512, "mobilenetv1/conv_7"),
			conv_8: extractConvPairParams(512, 512, "mobilenetv1/conv_8"),
			conv_9: extractConvPairParams(512, 512, "mobilenetv1/conv_9"),
			conv_10: extractConvPairParams(512, 512, "mobilenetv1/conv_10"),
			conv_11: extractConvPairParams(512, 512, "mobilenetv1/conv_11"),
			conv_12: extractConvPairParams(512, 1024, "mobilenetv1/conv_12"),
			conv_13: extractConvPairParams(1024, 1024, "mobilenetv1/conv_13")
		};
	}
...
function extractParams$2(weights) {
	...
	var output_layer = { extra_dim: Pn(extractWeights(5118 * 4), [
		1,
		5118,
		4
	]) };
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/extractParamsFromWeigthMap.js
function extractorsFactory$4(weightMap, paramMappings) {
	var extractWeightEntry = extractWeightEntryFactory(weightMap, paramMappings);
	function extractPointwiseConvParams(prefix, idx, mappedPrefix) {
		return {
			filters: extractWeightEntry(prefix + "/Conv2d_" + idx + "_pointwise/weights", 4, mappedPrefix + "/filters"),
			batch_norm_offset: extractWeightEntry(prefix + "/Conv2d_" + idx + "_pointwise/convolution_bn_offset", 1, mappedPrefix + "/batch_norm_offset")
		};
	}
	function extractConvPairParams(idx) {
		...
		return {
			depthwise_conv: {
				filters: extractWeightEntry(prefixDepthwiseConv + "/depthwise_weights", 4, mappedPrefixDepthwiseConv + "/filters"),
				batch_norm_scale: extractWeightEntry(prefixDepthwiseConv + "/BatchNorm/gamma", 1, mappedPrefixDepthwiseConv + "/batch_norm_scale"),
				batch_norm_offset: extractWeightEntry(prefixDepthwiseConv + "/BatchNorm/beta", 1, mappedPrefixDepthwiseConv + "/batch_norm_offset"),
				batch_norm_mean: extractWeightEntry(prefixDepthwiseConv + "/BatchNorm/moving_mean", 1, mappedPrefixDepthwiseConv + "/batch_norm_mean"),
				batch_norm_variance: extractWeightEntry(prefixDepthwiseConv + "/BatchNorm/moving_variance", 1, mappedPrefixDepthwiseConv + "/batch_norm_variance")
			},
	...
	function extractConvParams(prefix, mappedPrefix) {
		return {
			filters: extractWeightEntry(prefix + "/weights", 4, mappedPrefix + "/filters"),
			bias: extractWeightEntry(prefix + "/biases", 1, mappedPrefix + "/bias")
		};
	}
	function extractBoxPredictorParams(idx) {
		return {
			box_encoding_predictor: extractConvParams("Prediction/BoxPredictor_" + idx + "/BoxEncodingPredictor", "prediction_layer/box_predictor_" + idx + "/box_encoding_predictor"),
			class_predictor: extractConvParams("Prediction/BoxPredictor_" + idx + "/ClassPredictor", "prediction_layer/box_predictor_" + idx + "/class_predictor")
		};
	}
	function extractPredictionLayerParams() {
		return {
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/pointwiseConvLayer.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/mobileNetV1.js
var epsilon = .0010000000474974513;
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/nonMaxSuppression.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/outputLayer.js
function getCenterCoordinatesAndSizesLayer(x) {
	var vec = Ur(Wl(x, [1, 0]));
	var sizes = [Cc(vec[2], vec[0]), Cc(vec[3], vec[1])];
	return {
		sizes,
		centers: [rc(vec[0], sc(sizes[0], On(2))), rc(vec[1], sc(sizes[1], On(2)))]
	};
}
...
function outputLayer(boxPredictions, classPredictions, params) {
	return Ze(function() {
		...
		var boxes = decodeBoxesLayer(Or(Lr(params.extra_dim, [
			...
			1,
			1
		]), [-1, 4]), Or(boxPredictions, [-1, 4]));
		boxes = Or(boxes, [
			batchSize,
			boxes.shape[0] / batchSize,
			4
		]);
		var scores = ml(Iu(ml(classPredictions, [
			0,
			0,
			1
		], [
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/boxPredictionLayer.js
function boxPredictionLayer(x, params) {
	return Ze(function() {
		var batchSize = x.shape[0];
		return {
			boxPredictionEncoding: Or(convLayer$1(x, params.box_encoding_predictor), [
				batchSize,
				-1,
				1,
				4
			]),
			classPrediction: Or(convLayer$1(x, params.class_predictor), [
				batchSize,
				-1,
				3
			])
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/predictionLayer.js
function predictionLayer(x, conv11, params) {
	return Ze(function() {
		var conv1 = pointwiseConvLayer(pointwiseConvLayer(x, params.conv_0, [1, 1]), params.conv_1, [2, 2]);
		var conv3 = pointwiseConvLayer(pointwiseConvLayer(conv1, params.conv_2, [1, 1]), params.conv_3, [2, 2]);
		var conv5 = pointwiseConvLayer(pointwiseConvLayer(conv3, params.conv_4, [1, 1]), params.conv_5, [2, 2]);
		var conv7 = pointwiseConvLayer(pointwiseConvLayer(conv5, params.conv_6, [1, 1]), params.conv_7, [2, 2]);
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/SsdMobilenetv1Options.js
var SsdMobilenetv1Options = function() {
	function SsdMobilenetv1Options(_a) {
		...
		this._minConfidence = minConfidence || .5;
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/SsdMobilenetv1.js
var SsdMobilenetv1 = function(_super) {
	...
	SsdMobilenetv1.prototype.forwardInput = function(input) {
		...
		return Ze(function() {
			var features = mobileNetV1(Cc(gc(input.toBatchTensor(512, false).toFloat(), On(.007843137718737125)), On(1)), params.mobilenetv1);
				...
				switch (_e.label) {
					...
					case 2:
						...
						results = indices.map(function(idx) {
							var _a = [Math.max(0, boxesData[idx][0]), Math.min(1, boxesData[idx][2])].map(function(val) {
								return val * padY;
							}), top = _a[0], bottom = _a[1];
							var _b = [Math.max(0, boxesData[idx][1]), Math.min(1, boxesData[idx][3])].map(function(val) {
								return val * padX;
...
//#endregion
//#region node_modules/face-api.js/build/es6/ssdMobilenetv1/index.js
...
var FaceDetectionNet = function(_super) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/const.js
var IOU_THRESHOLD$1 = .4;
var BOX_ANCHORS$1 = [
	new Point(.738768, .874946),
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/config.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/leaky.js
function leaky(x) {
	return Ze(function() {
		var min = gc(x, On(.10000000149011612));
		return rc(Bl(Cc(x, min)), min);
	});
}
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/convWithBatchNorm.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/depthwiseSeparableConv.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/extractParams.js
function extractorsFactory$3(extractWeights, paramMappings) {
	...
	function extractConvWithBatchNormParams(channelsIn, channelsOut, mappedPrefix) {
		return {
			conv: extractConvParams(channelsIn, channelsOut, 3, mappedPrefix + "/conv"),
			bn: extractBatchNormParams(channelsOut, mappedPrefix + "/bn")
		};
	}
	return {
		extractConvParams,
		extractConvWithBatchNormParams,
		extractSeparableConvParams: extractSeparableConvParamsFactory(extractWeights, paramMappings)
	};
}
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/extractParamsFromWeigthMap.js
function extractorsFactory$2(weightMap, paramMappings) {
	var extractWeightEntry = extractWeightEntryFactory(weightMap, paramMappings);
	function extractBatchNormParams(prefix) {
		return {
			sub: extractWeightEntry(prefix + "/sub", 1),
			truediv: extractWeightEntry(prefix + "/truediv", 1)
		};
	}
	...
	function extractConvWithBatchNormParams(prefix) {
		return {
			conv: extractConvParams(prefix + "/conv"),
			bn: extractBatchNormParams(prefix + "/bn")
		};
	}
	return {
		extractConvParams,
		extractConvWithBatchNormParams,
		extractSeparableConvParams: loadSeparableConvParamsFactory(extractWeightEntry)
	};
}
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/TinyYolov2Options.js
...
var TinyYolov2Options = function() {
	function TinyYolov2Options(_a) {
		...
		this._scoreThreshold = scoreThreshold || .5;
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/TinyYolov2Base.js
var TinyYolov2Base = function(_super) {
	...
	TinyYolov2Base.prototype.runMobilenet = function(x, params) {
		var out = this.config.isFirstLayerConv2d ? leaky(convLayer$1(x, params.conv0, "valid", false)) : depthwiseSeparableConv(x, params.conv0);
		out = hl(out, [2, 2], [2, 2], "same");
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					case 0:
						_a = this.forwardInput;
						return [4, toNetInput(input)];
					case 1: return [4, _a.apply(this, [_b.sent(), inputSize])];
					...
					case 0:
						...
						_a = Ze(function() {
							...
							return [
								...
								_this.withClassScores ? go(reshaped.slice([
									0,
									0,
									0,
									5
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/TinyYolov2.js
var TinyYolov2 = function(_super) {
	...
	TinyYolov2.prototype.locateFaces = function(input, forwardParams) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0: return [4, this.detect(input, forwardParams)];
					case 1:
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyYolov2/index.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyFaceDetector/TinyFaceDetectorOptions.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/ComposableTask.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/extractFacesAndComputeResults.js
		...
		return __generator(this, function(_c) {
			switch (_c.label) {
				...
				case 1:
					_b = _c.sent();
					return [3, 4];
				case 2: return [4, extractFaces(input, faceBoxes)];
				case 3:
					_b = _c.sent();
					_c.label = 4;
				case 4:
				...
				case 6:
					...
					faces.forEach(function(f) {
						return f instanceof wt && f.dispose();
					});
					return [2, results];
			}
		});
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/bgrToRgbTensor.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/extractParams.js
function extractorsFactory$1(extractWeights, paramMappings) {
	...
	function extractSharedParams(numFilters, mappedPrefix, isRnet) {
		...
		return {
			conv1: extractConvParams(numFilters[0], numFilters[1], 3, mappedPrefix + "/conv1"),
			prelu1_alpha: extractPReluParams(numFilters[1], mappedPrefix + "/prelu1_alpha"),
			conv2: extractConvParams(numFilters[1], numFilters[2], 3, mappedPrefix + "/conv2"),
			prelu2_alpha: extractPReluParams(numFilters[2], mappedPrefix + "/prelu2_alpha"),
			conv3: extractConvParams(numFilters[2], numFilters[3], isRnet ? 2 : 3, mappedPrefix + "/conv3"),
			prelu3_alpha: extractPReluParams(numFilters[3], mappedPrefix + "/prelu3_alpha")
		};
	}
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/extractParamsFromWeigthMap.js
function extractorsFactory(weightMap, paramMappings) {
	var extractWeightEntry = extractWeightEntryFactory(weightMap, paramMappings);
	function extractConvParams(prefix) {
		return {
			filters: extractWeightEntry(prefix + "/weights", 4, prefix + "/filters"),
			bias: extractWeightEntry(prefix + "/bias", 1)
		};
	}
	function extractFCParams(prefix) {
	...
	function extractSharedParams(prefix) {
		return {
			conv1: extractConvParams(prefix + "/conv1"),
			prelu1_alpha: extractPReluParams(prefix + "/prelu1_alpha"),
			conv2: extractConvParams(prefix + "/conv2"),
			prelu2_alpha: extractPReluParams(prefix + "/prelu2_alpha"),
			conv3: extractConvParams(prefix + "/conv3"),
			prelu3_alpha: extractPReluParams(prefix + "/prelu3_alpha")
		};
	}
	function extractPNetParams() {
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/getSizesForScale.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/pyramidDown.js
function pyramidDown(minFaceSize, scaleFactor, dims) {
	var height = dims[0], width = dims[1];
	var m = 12 / minFaceSize;
	var scales = [];
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/MtcnnBox.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/normalize.js
function normalize$1(x) {
	return Ze(function() {
		return gc(Cc(x, On(127.5)), On(.0078125));
	});
}
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/prelu.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/sharedLayers.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/PNet.js
function PNet(x, params) {
	return Ze(function() {
		var out = sharedLayer(x, params, true);
		var conv = convLayer$1(out, params.conv4_1, "valid");
		return {
			prob: go(Cc(conv, wr(Sl(conv, 3), 3)), 3),
			regions: convLayer$1(out, params.conv4_2, "valid")
		};
	});
}
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/stage1.js
function rescaleAndNormalize(x, scale) {
	return Ze(function() {
		var _a = getSizesForScale(scale, x.shape.slice(1)), height = _a.height, width = _a.width;
		return Wl(normalize$1(Oh.resizeBilinear(x, [height, width])), [
			0,
			2,
			1,
			3
...
function extractBoundingBoxes(scoresTensor, regionsTensor, scale, scoreThreshold) {
	...
	for (var y = 0; y < scoresTensor.shape[0]; y++) for (var x = 0; x < scoresTensor.shape[1]; x++) if (scoresData[y][x] >= scoreThreshold) indices.push(new Point(x, y));
	return indices.map(function(idx) {
		var cell = new BoundingBox(Math.round((idx.y * 2 + 1) / scale), Math.round((idx.x * 2 + 1) / scale), Math.round((idx.y * 2 + 12) / scale), Math.round((idx.x * 2 + 12) / scale));
...
function stage1(imgTensor, scales, scoreThreshold, params, stats) {
	stats.stage1 = [];
	var allBoxes = scales.map(function(scale) {
		return Ze(function() {
			var statsForScale = { scale };
			var resized = rescaleAndNormalize(imgTensor, scale);
			var ts = Date.now();
			var _a = PNet(resized, params), prob = _a.prob, regions = _a.regions;
			statsForScale.pnet = Date.now() - ts;
			return {
				scoresTensor: Ur(Ur(prob, 3)[1])[0],
				regionsTensor: Ur(regions)[0],
				scale,
				statsForScale
			};
		});
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/extractImagePatches.js
			...
			switch (_b.label) {
				...
				case 1:
					...
					bitmaps.forEach(function(bmp) {
						var patchCtx = getContext2dOrThrow(createCanvas({
							width,
							height
						}));
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/RNet.js
function RNet(x, params) {
	return Ze(function() {
		var convOut = sharedLayer(x, params);
		var prelu4 = prelu(fullyConnectedLayer(Or(convOut, [convOut.shape[0], params.fc1.weights.shape[0]]), params.fc1), params.prelu4_alpha);
		var fc2_1 = fullyConnectedLayer(prelu4, params.fc2_1);
		var prob = go(Cc(fc2_1, wr(Sl(fc2_1, 1), 1)), 1);
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/stage2.js
	...
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(_c) {
			switch (_c.label) {
				case 0:
					ts = Date.now();
					return [4, extractImagePatches(img, inputBoxes, {
						width: 24,
						height: 24
					})];
				case 1:
				...
				case 2:
					...
					if (filteredBoxes.length > 0) {
						ts = Date.now();
						indicesNms = nonMaxSuppression(filteredBoxes, filteredScores, .7);
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/ONet.js
function ONet(x, params) {
	return Ze(function() {
		...
		var prelu5 = prelu(fullyConnectedLayer(Or(out, [out.shape[0], params.fc1.weights.shape[0]]), params.fc1), params.prelu5_alpha);
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/stage3.js
		...
		return __generator(this, function(_c) {
			switch (_c.label) {
				...
				case 2:
					...
					if (filteredBoxes.length > 0) {
						ts = Date.now();
						indicesNms = nonMaxSuppression(filteredBoxes, filteredScores, .7, false);
...
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/Mtcnn.js
				...
				switch (_c.label) {
					case 0:
						...
						scales = (scaleSteps || pyramidDown(minFaceSize, scaleFactor, [height, width])).filter(function(scale) {
							...
							return Math.min(sizes.width, sizes.height) > 12;
					...
					case 1:
						...
						if (!out1.boxes.length) return [2, onReturn({
							results: [],
							stats
						})];
					...
					case 2:
						...
						if (!out2.boxes.length) return [2, onReturn({
							results: [],
							stats
						})];
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					case 0:
						_a = this.forwardInput;
						return [4, toNetInput(input)];
					case 1: return [4, _a.apply(this, [_b.sent(), forwardParams])];
					case 2: return [2, _b.sent().results];
				}
			});
		});
	};
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					case 0:
						_a = this.forwardInput;
						return [4, toNetInput(input)];
					case 1: return [2, _a.apply(this, [_b.sent(), forwardParams])];
				}
			});
		});
	};
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyFaceDetector/const.js
var IOU_THRESHOLD = .4;
var BOX_ANCHORS = [
	new Point(1.603231, 2.094468),
	new Point(6.041143, 7.080126),
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyFaceDetector/TinyFaceDetector.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/nets.js
var nets = {
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/PredictFaceExpressionsTask.js
					...
					case 1:
						...
						return [4, extractAllFacesAndComputeResults(parentResults, this.input, function(faces) {
							return __awaiter(_this, void 0, void 0, function() {
								return __generator(this, function(_a) {
									switch (_a.label) {
										case 0: return [4, Promise.all(faces.map(function(face) {
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/PredictAgeAndGenderTask.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/ComputeFaceDescriptorsTasks.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/DetectFaceLandmarksTasks.js
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					...
					case 2:
						_a = _b.sent();
						return [3, 5];
					case 3: return [4, extractFaces(this.input, detections)];
					case 4:
						_a = _b.sent();
						_b.label = 5;
					case 5:
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					...
					case 2:
						_a = _b.sent();
						return [3, 5];
					case 3: return [4, extractFaces(this.input, [detection])];
					case 4:
						_a = _b.sent();
						_b.label = 5;
					case 5:
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/DetectFacesTasks.js
		...
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_b) {
				switch (_b.label) {
					...
					case 1: return [2, _b.sent().map(function(result) {
...
var DetectSingleFaceTask = function(_super) {
	...
	DetectSingleFaceTask.prototype.run = function() {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0: return [4, new DetectAllFacesTask(this.input, this.options)];
					case 1:
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/detectFaces.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/allFaces.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/euclideanDistance.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/globalApi/FaceMatcher.js
var FaceMatcher = function() {
	function FaceMatcher(inputs, distanceThreshold) {
		if (distanceThreshold === void 0) distanceThreshold = .6;
	...
	FaceMatcher.fromJSON = function(json) {
		return new FaceMatcher(json.labeledDescriptors.map(function(ld) {
			return LabeledFaceDescriptors.fromJSON(ld);
		}), json.distanceThreshold);
	};
	return FaceMatcher;
}();
//#endregion
//#region node_modules/face-api.js/build/es6/mtcnn/index.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/tinyFaceDetector/index.js
...
//#endregion
//#region node_modules/face-api.js/build/es6/resizeResults.js
